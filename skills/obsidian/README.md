...
```
/obsidian:obsidian organize           # Vault structure advice
/obsidian:obsidian dataview "tasks"    # Dataview query help
/obsidian:obsidian templater           # Template creation
/obsidian:obsidian workflow zettelkasten  # Workflow setup
/obsidian:obsidian plugin dataview     # Plugin guide
/obsidian:obsidian mcp                 # MCP server setup
/obsidian:obsidian sync                # Update docs
```
