...
- <a href="#openclaw-agent-direct-agent-runs" class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">openclaw agent (direct agent runs)</a>
...
<a href="#openclaw-agent-direct-agent-runs" class="-ml-10 flex items-center opacity-0 border-0 group-hover:opacity-100 focus:opacity-100 focus:outline-0 group/link" aria-label="Navigate to header">​</a>
...
<a href="/tools/browser-linux-troubleshooting" class="flex items-center space-x-3 group"><span class="group-hover:text-gray-900 dark:group-hover:text-white">Browser Troubleshooting</span></a><a href="/tools/subagents" class="flex items-center ml-auto space-x-3 group"><span class="group-hover:text-gray-900 dark:group-hover:text-white">Sub-Agents</span></a>
