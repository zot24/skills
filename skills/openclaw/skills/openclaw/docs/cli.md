...
- <span id="/tools/agent-send"><a href="/tools/agent-send" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] bg-primary/10 text-primary [text-shadow:-0.2px_0_0_currentColor,0.2px_0_0_currentColor] dark:text-primary-light dark:bg-primary-light/10" style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <a href="#examples" class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Examples</a>
...
<a href="#behavior" class="-ml-10 flex items-center opacity-0 border-0 group-hover:opacity-100 focus:opacity-100 focus:outline-0 group/link" aria-label="Navigate to header">​</a>
...
- <a href="/cli/agent" class="link">Agent CLI reference</a>
- <a href="/tools/subagents" class="link">Sub-agents</a> — background sub-agent spawning
- <a href="/concepts/session" class="link">Sessions</a> — how session keys work


<a href="/tools/thinking" class="flex items-center space-x-3 group"><span class="group-hover:text-gray-900 dark:group-hover:text-white">Thinking Levels</span></a><a href="/tools/subagents" class="flex items-center ml-auto space-x-3 group"><span class="group-hover:text-gray-900 dark:group-hover:text-white">Sub-Agents</span></a>
