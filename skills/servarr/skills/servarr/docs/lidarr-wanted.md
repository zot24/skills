> Source: https://wiki.servarr.com/lidarr/wanted



# <a href="#wanted" class="toc-anchor">¶</a> Wanted
...
# <a href="#missing" class="toc-anchor">¶</a> Missing
...
## <a href="#toolbar-actions" class="toc-anchor">¶</a> Toolbar actions
...
- **Manual Import**: opens the manual import dialog, letting you match files in any accessible folder to albums in your library. Use this when you have files on disk that Lidarr hasn't picked up automatically. See <a href="/lidarr/import-troubleshooting" class="is-internal-link is-valid-page">Import Troubleshooting</a> for guidance.
...
## <a href="#per-row-actions" class="toc-anchor">¶</a> Per-row actions
...
# <a href="#cutoff-unmet" class="toc-anchor">¶</a> Cutoff Unmet
...
## <a href="#toolbar-actions-1" class="toc-anchor">¶</a> Toolbar actions
...
## <a href="#per-row-actions-1" class="toc-anchor">¶</a> Per-row actions
