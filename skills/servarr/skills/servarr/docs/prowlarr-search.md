> Source: https://wiki.servarr.com/prowlarr/search
...
# <a href="#performing-a-search" class="toc-anchor">¶</a> Performing a Search
...
# <a href="#api-endpoints" class="toc-anchor">¶</a> API Endpoints

## <a href="#rss-compatible-single-indexer-feed" class="toc-anchor">¶</a> RSS Compatible - Single Indexer Feed
...
### <a href="#api-key-in-query" class="toc-anchor">¶</a> API Key in Query
...
### <a href="#api-key-in-header" class="toc-anchor">¶</a> API Key in Header
...
## <a href="#search-feed" class="toc-anchor">¶</a> Search Feed
