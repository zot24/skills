...
- See <a href="/radarr/tips-and-tricks#creating-a-folder-for-each-movie" class="is-internal-link is-valid-page">Tips and Tricks Section =&gt; Create a Folder for Each Movie</a> for more details.
