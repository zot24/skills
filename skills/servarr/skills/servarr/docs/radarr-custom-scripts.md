> Source: https://wiki.servarr.com/radarr/custom-scripts



If you're looking to trigger a custom script, you can find more details here. Scripts are added to Radarr via the <a href="/radarr/settings#connections" class="is-internal-link is-valid-page">Connect Settings</a>.
...
## <a href="#radarr-logs" class="toc-anchor">¶</a> Radarr Logs
...
## <a href="#on-movie-added" class="toc-anchor">¶</a> On Movie Added
...
## <a href="#on-movie-delete" class="toc-anchor">¶</a> On Movie Delete
...
## <a href="#on-movie-file-delete" class="toc-anchor">¶</a> On Movie File Delete
...
## <a href="#on-health-check" class="toc-anchor">¶</a> On Health Check
