> Source: https://wiki.servarr.com/prowlarr/settings
...
This page will go through all the settings available in Prowlarr and how they work. This is not meant to be a comprehensive "how to set up Prowlarr." If you want that, please use the <a href="/prowlarr/quick-start-guide" class="is-internal-link is-valid-page">Quick Start</a> page instead.
...
> Information on supported proxy types can be found at the <a href="/prowlarr/supported#indexer-proxies" class="is-internal-link is-valid-page">More Info (Supported)</a> page for this section
...
## <a href="#proxy-settings" class="toc-anchor">¶</a> Proxy Settings
...
## <a href="#flaresolverr-proxy-settings" class="toc-anchor">¶</a> FlareSolverr Proxy Settings

- Host - the full host path (include http and the port) to your FlareSolverr instance
- (Advanced Setting) Request Timeout (seconds) - the <a href="https://github.com/FlareSolverr/FlareSolverr#-requestget" class="is-external-link">FlareSolver Request <code>maxTimeout</code> value</a> Prowlarr should use for FlareSolverr requests. Must be between `1` second and `180` seconds (Default: `60` seconds)
...
## <a href="#http-proxy-settings" class="toc-anchor">¶</a> HTTP Proxy Settings
...
## <a href="#socks4-proxy-settings" class="toc-anchor">¶</a> Socks4 Proxy Settings
...
## <a href="#socks5-proxy-settings" class="toc-anchor">¶</a> Socks5 Proxy Settings
...
> Information on supported applications can be found at the <a href="/prowlarr/supported#applications" class="is-internal-link is-valid-page">More Info (Supported)</a> page for this section
...
- Click on `Settings` =\> `Apps`, and then click the + to add an app.
...
## <a href="#application-settings" class="toc-anchor">¶</a> Application Settings
...
- Sync Level - Select the sync level to use
  ...
  - `Full Sync` - Full Sync will keep this app's indexers fully in sync. Changes made to indexers in Prowlarr are then synced to this app. Any change made to the settings on the FAQ for these indexers remotely within this app will be overridden by Prowlarr on the next sync. A list of factors used to compare and determine if a sync should occur can be found in the <a href="/prowlarr/faq#what-arr-indexer-settings-are-compared-for-app-full-sync" class="is-internal-link is-valid-page">FAQ</a>
  - `Disabled` - will keep indexers from syncing with the program entirely.

> `Full Sync` means Prowlarr will override most settings including user selected categories configurable in Prowlarr. However, non-Prowlarr managed settings will not be touched. However, <a href="/prowlarr/faq#what-arr-indexer-settings-are-compared-for-app-full-sync" class="is-internal-link is-valid-page">just about every other factor of changes</a> will trigger a sync and overwrite the corresponding settings in \*Arr
...
## <a href="#testing-the-application" class="toc-anchor">¶</a> Testing the Application
...
## <a href="#sync-profiles" class="toc-anchor">¶</a> Sync Profiles
...
# <a href="#download-clients-prowlarr-searches" class="toc-anchor">¶</a> Download Clients (Prowlarr Searches)

> Information on supported download clients can be found at the <a href="/prowlarr/supported#download-clients" class="is-internal-link is-valid-page">More Info (Supported)</a> page for this section
...
> Information on supported notification providers can be found at the <a href="/prowlarr/supported#notifications" class="is-internal-link is-valid-page">More Info (Supported)</a> page for this section
...
- A list of supported notifications and connections is located at the <a href="/prowlarr/supported#notifications" class="is-internal-link is-valid-page">More Info (Supported)</a>

## <a href="#notification-triggers" class="toc-anchor">¶</a> Notification Triggers
...
- (Advanced Option) Branch - This is the branch of Prowlarr that you are running on.
  - <a href="/prowlarr/faq#how-do-i-update-prowlarr" class="is-internal-link is-valid-page">Please see this FAQ entry for more information</a>
...
- Theme - Select the color theme Prowlarr should use inspired by <a href="https://github.com/GilbN/theme.park" class="is-external-link">Theme.Park</a>
