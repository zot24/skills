...
System information, logs, scheduled tasks, and status monitoring for Prowlarr administration and troubleshooting
...
[prowlarr](https://wiki.servarr.com/t/prowlarr) [system](https://wiki.servarr.com/t/system) [logs](https://wiki.servarr.com/t/logs) [administration](https://wiki.servarr.com/t/administration) [tasks](https://wiki.servarr.com/t/tasks) [status](https://wiki.servarr.com/t/status) [Pages matching tags](https://wiki.servarr.com/t/prowlarr/system/logs/administration/tasks/status)
...
# [¶](https://wiki.servarr.com/prowlarr/system\#table-of-contents) Table of Contents

- [Table of Contents](https://wiki.servarr.com/prowlarr/system#table-of-contents)
- [Status](https://wiki.servarr.com/prowlarr/system#status)
  - [Health](https://wiki.servarr.com/prowlarr/system#health)
    - [System Warnings](https://wiki.servarr.com/prowlarr/system#system-warnings)
      - [Branch is not a valid release branch](https://wiki.servarr.com/prowlarr/system#branch-is-not-a-valid-release-branch)
      - [Currently installed SQLite version is not supported](https://wiki.servarr.com/prowlarr/system#currently-installed-sqlite-version-is-not-supported)
      - [New update is available](https://wiki.servarr.com/prowlarr/system#new-update-is-available)
      - [Cannot install update because startup folder is not writable by the user](https://wiki.servarr.com/prowlarr/system#cannot-install-update-because-startup-folder-is-not-writable-by-the-user)
      - [Updating will not be possible to prevent deleting AppData on Update](https://wiki.servarr.com/prowlarr/system#updating-will-not-be-possible-to-prevent-deleting-appdata-on-update)
      - [Branch is for a previous version](https://wiki.servarr.com/prowlarr/system#branch-is-for-a-previous-version)
      - [Could not connect to signalR](https://wiki.servarr.com/prowlarr/system#could-not-connect-to-signalr)
      - [Failed to resolve the IP Address for the Configured Proxy Host](https://wiki.servarr.com/prowlarr/system#failed-to-resolve-the-ip-address-for-the-configured-proxy-host)
      - [Proxy Failed Test](https://wiki.servarr.com/prowlarr/system#proxy-failed-test)
      - [System Time is off by more than 1 day](https://wiki.servarr.com/prowlarr/system#system-time-is-off-by-more-than-1-day)
    - [Download Clients](https://wiki.servarr.com/prowlarr/system#download-clients)
      - [No download client is available](https://wiki.servarr.com/prowlarr/system#no-download-client-is-available)
      - [Unable to communicate with download client](https://wiki.servarr.com/prowlarr/system#unable-to-communicate-with-download-client)
      - [Download clients are unavailable due to failure](https://wiki.servarr.com/prowlarr/system#download-clients-are-unavailable-due-to-failure)
      - [Bad Download Client Settings](https://wiki.servarr.com/prowlarr/system#bad-download-client-settings)
    - [Indexers](https://wiki.servarr.com/prowlarr/system#indexers)
      - [Indexers Have No Definition](https://wiki.servarr.com/prowlarr/system#indexers-have-no-definition)
      - [Indexers are Obsolete](https://wiki.servarr.com/prowlarr/system#indexers-are-obsolete)
        - [Obsolete due to Code Changes](https://wiki.servarr.com/prowlarr/system#obsolete-due-to-code-changes)
        - [Obsolete due to Site Removals](https://wiki.servarr.com/prowlarr/system#obsolete-due-to-site-removals)
      - [No indexers are enabled](https://wiki.servarr.com/prowlarr/system#no-indexers-are-enabled)
      - [Indexers are unavailable due to failures](https://wiki.servarr.com/prowlarr/system#indexers-are-unavailable-due-to-failures)
      - [Indexer VIP Expiring](https://wiki.servarr.com/prowlarr/system#indexer-vip-expiring)
      - [Indexer VIP Expired](https://wiki.servarr.com/prowlarr/system#indexer-vip-expired)
    - [Applications](https://wiki.servarr.com/prowlarr/system#applications)
      - [Applications are unavailable due to failures](https://wiki.servarr.com/prowlarr/system#applications-are-unavailable-due-to-failures)
  - [Disk Space](https://wiki.servarr.com/prowlarr/system#disk-space)
  - [About](https://wiki.servarr.com/prowlarr/system#about)
  - [More Info](https://wiki.servarr.com/prowlarr/system#more-info)
- [Tasks](https://wiki.servarr.com/prowlarr/system#tasks)
  - [Scheduled](https://wiki.servarr.com/prowlarr/system#scheduled)
  - [Queue](https://wiki.servarr.com/prowlarr/system#queue)
- [Backup](https://wiki.servarr.com/prowlarr/system#backup)
- [Updates](https://wiki.servarr.com/prowlarr/system#updates)
- [Events](https://wiki.servarr.com/prowlarr/system#events)
- [Log Files](https://wiki.servarr.com/prowlarr/system#log-files)

# [¶](https://wiki.servarr.com/prowlarr/system\#status) Status

## [¶](https://wiki.servarr.com/prowlarr/system\#health) Health
...
### [¶](https://wiki.servarr.com/prowlarr/system\#system-warnings) System Warnings

#### [¶](https://wiki.servarr.com/prowlarr/system\#branch-is-not-a-valid-release-branch) Branch is not a valid release branch

- The branch you have set is not a valid release branch. You will not receive updates. Please change to one of the [current release branches](https://wiki.servarr.com/prowlarr/faq#how-do-i-update-prowlarr).

#### [¶](https://wiki.servarr.com/prowlarr/system\#currently-installed-sqlite-version-is-not-supported) Currently installed SQLite version is not supported
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#new-update-is-available) New update is available
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#cannot-install-update-because-startup-folder-is-not-writable-by-the-user) Cannot install update because startup folder is not writable by the user
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#updating-will-not-be-possible-to-prevent-deleting-appdata-on-update) Updating will not be possible to prevent deleting AppData on Update
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#branch-is-for-a-previous-version) Branch is for a previous version
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#could-not-connect-to-signalr) Could not connect to signalR
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#failed-to-resolve-the-ip-address-for-the-configured-proxy-host) Failed to resolve the IP Address for the Configured Proxy Host

- Review your proxy settings and ensure they are accurate
- Ensure your proxy is up, running, and accessible

#### [¶](https://wiki.servarr.com/prowlarr/system\#proxy-failed-test) Proxy Failed Test

- Your configured proxy failed to test successfully, review the HTTP error provided and/or check logs for more details.

#### [¶](https://wiki.servarr.com/prowlarr/system\#system-time-is-off-by-more-than-1-day) System Time is off by more than 1 day
...
### [¶](https://wiki.servarr.com/prowlarr/system\#download-clients) Download Clients

#### [¶](https://wiki.servarr.com/prowlarr/system\#no-download-client-is-available) No download client is available
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#unable-to-communicate-with-download-client) Unable to communicate with download client
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#download-clients-are-unavailable-due-to-failure) Download clients are unavailable due to failure
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#bad-download-client-settings) Bad Download Client Settings
...
### [¶](https://wiki.servarr.com/prowlarr/system\#indexers) Indexers

#### [¶](https://wiki.servarr.com/prowlarr/system\#indexers-have-no-definition) Indexers Have No Definition
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#indexers-are-obsolete) Indexers are Obsolete

- Your indexer(s)'s definition is obsolete and out of date. This has one of two causes which are noted below

##### [¶](https://wiki.servarr.com/prowlarr/system\#obsolete-due-to-code-changes) Obsolete due to Code Changes
...
##### [¶](https://wiki.servarr.com/prowlarr/system\#obsolete-due-to-site-removals) Obsolete due to Site Removals
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#no-indexers-are-enabled) No indexers are enabled

- Prowlarr requires indexers to be able to discover new releases. Please read the wiki instructions how to add indexers.

#### [¶](https://wiki.servarr.com/prowlarr/system\#indexers-are-unavailable-due-to-failures) Indexers are unavailable due to failures
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#indexer-vip-expiring) Indexer VIP Expiring
...
#### [¶](https://wiki.servarr.com/prowlarr/system\#indexer-vip-expired) Indexer VIP Expired
...
### [¶](https://wiki.servarr.com/prowlarr/system\#applications) Applications

#### [¶](https://wiki.servarr.com/prowlarr/system\#applications-are-unavailable-due-to-failures) Applications are unavailable due to failures
...
## [¶](https://wiki.servarr.com/prowlarr/system\#disk-space) Disk Space
...
## [¶](https://wiki.servarr.com/prowlarr/system\#about) About

This will tell you about your current install of Prowlarr

## [¶](https://wiki.servarr.com/prowlarr/system\#more-info) More Info
...
# [¶](https://wiki.servarr.com/prowlarr/system\#tasks) Tasks

## [¶](https://wiki.servarr.com/prowlarr/system\#scheduled) Scheduled
...
## [¶](https://wiki.servarr.com/prowlarr/system\#queue) Queue

The queue will show you upcoming tasks as well as a history of recently ran tasks as well as how long those tasks took.

# [¶](https://wiki.servarr.com/prowlarr/system\#backup) Backup

> This section will be more tailored to the buttons and overall point of the page.
>
> However, if you're looking for how to back/restore your Prowlarr instance [see our FAQ](https://wiki.servarr.com/prowlarr/faq).
...
# [¶](https://wiki.servarr.com/prowlarr/system\#updates) Updates
...
# [¶](https://wiki.servarr.com/prowlarr/system\#events) Events
...
# [¶](https://wiki.servarr.com/prowlarr/system\#log-files) Log Files
