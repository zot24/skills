...
[radarr](https://wiki.servarr.com/t/radarr) [troubleshooting](https://wiki.servarr.com/t/troubleshooting) [faq](https://wiki.servarr.com/t/faq) [Pages matching tags](https://wiki.servarr.com/t/radarr/troubleshooting/faq)
...
# [¶](https://wiki.servarr.com/radarr/faq\#table-of-contents) Table of Contents

- [Table of Contents](https://wiki.servarr.com/radarr/faq#table-of-contents)
- [Radarr Basics](https://wiki.servarr.com/radarr/faq#radarr-basics)
  - [How does Radarr work?](https://wiki.servarr.com/radarr/faq#how-does-radarr-work)
  - [How does Radarr find movies?](https://wiki.servarr.com/radarr/faq#how-does-radarr-find-movies)
  - [How do I access Radarr from another computer?](https://wiki.servarr.com/radarr/faq#how-do-i-access-radarr-from-another-computer)
  - [Forced Authentication](https://wiki.servarr.com/radarr/faq#forced-authentication)
    - [Authentication Method](https://wiki.servarr.com/radarr/faq#authentication-method)
    - [Authentication Required](https://wiki.servarr.com/radarr/faq#authentication-required)
  - [What is Minimum Availability?](https://wiki.servarr.com/radarr/faq#what-is-minimum-availability)
  - [How are possible downloads compared?](https://wiki.servarr.com/radarr/faq#how-are-possible-downloads-compared)
  - [What are Lists and what can they do for me?](https://wiki.servarr.com/radarr/faq#what-are-lists-and-what-can-they-do-for-me)
    - [Why are lists sync times so long and can I change it?](https://wiki.servarr.com/radarr/faq#why-are-lists-sync-times-so-long-and-can-i-change-it)
  - [Can all my movie files be stored in one folder?](https://wiki.servarr.com/radarr/faq#can-all-my-movie-files-be-stored-in-one-folder)
  - [Can I put all my movies in my library into one folder?](https://wiki.servarr.com/radarr/faq#can-i-put-all-my-movies-in-my-library-into-one-folder)
  - [How do I update Radarr?](https://wiki.servarr.com/radarr/faq#how-do-i-update-radarr)
    - [Can I update Radarr inside my Docker container?](https://wiki.servarr.com/radarr/faq#can-i-update-radarr-inside-my-docker-container)
    - [Installing a newer version](https://wiki.servarr.com/radarr/faq#installing-a-newer-version)
      - [Native](https://wiki.servarr.com/radarr/faq#native)
      - [Docker](https://wiki.servarr.com/radarr/faq#docker)
  - [Can I switch from `nightly` back to `develop`?](https://wiki.servarr.com/radarr/faq#can-i-switch-from-nightly-back-to-develop)
  - [Can I switch between branches?](https://wiki.servarr.com/radarr/faq#can-i-switch-between-branches)
  - [How do I Backup/Restore Radarr?](https://wiki.servarr.com/radarr/faq#how-do-i-backuprestore-radarr)
    - [Backing up Radarr](https://wiki.servarr.com/radarr/faq#backing-up-radarr)
      - [Using built-in backup](https://wiki.servarr.com/radarr/faq#using-built-in-backup)
      - [Using file system directly](https://wiki.servarr.com/radarr/faq#using-file-system-directly)
    - [Restoring from Backup](https://wiki.servarr.com/radarr/faq#restoring-from-backup)
      - [Using zip backup](https://wiki.servarr.com/radarr/faq#using-zip-backup)
      - [Using file system backup](https://wiki.servarr.com/radarr/faq#using-file-system-backup)
      - [File System Restore on Synology NAS](https://wiki.servarr.com/radarr/faq#file-system-restore-on-synology-nas)
- [Radarr Common Problems](https://wiki.servarr.com/radarr/faq#radarr-common-problems)
  - [A Task was Canceled](https://wiki.servarr.com/radarr/faq#a-task-was-canceled)
  - [Path is Already Configured for an Existing Movie](https://wiki.servarr.com/radarr/faq#path-is-already-configured-for-an-existing-movie)
  - [How can I rename my movie folders?](https://wiki.servarr.com/radarr/faq#how-can-i-rename-my-movie-folders)
  - [Movie File and Folder Naming](https://wiki.servarr.com/radarr/faq#movie-file-and-folder-naming)
  - [Movie Folders Named Incorrectly](https://wiki.servarr.com/radarr/faq#movie-folders-named-incorrectly)
  - [Can I disable the refresh movies task](https://wiki.servarr.com/radarr/faq#can-i-disable-the-refresh-movies-task)
  - [How do I request a feature for Radarr?](https://wiki.servarr.com/radarr/faq#how-do-i-request-a-feature-for-radarr)
  - [Help, My Mac says Radarr cannot be opened because the developer cannot be verified](https://wiki.servarr.com/radarr/faq#help-my-mac-says-radarr-cannot-be-opened-because-the-developer-cannot-be-verified)
  - [Help, My Mac says Radarr.app is damaged and can’t be opened](https://wiki.servarr.com/radarr/faq#help-my-mac-says-radarrapp-is-damaged-and-cant-be-opened)
  - [I am getting an error: Database disk image is malformed](https://wiki.servarr.com/radarr/faq#i-am-getting-an-error-database-disk-image-is-malformed)
  - [I use Radarr on a Mac and it suddenly stopped working. What happened?](https://wiki.servarr.com/radarr/faq#i-use-radarr-on-a-mac-and-it-suddenly-stopped-working-what-happened)
  - [Why can Radarr not see my files on a remote server?](https://wiki.servarr.com/radarr/faq#why-can-radarr-not-see-my-files-on-a-remote-server)
    - [Radarr runs under the LocalService account by default which doesn't have access to protected remote file shares](https://wiki.servarr.com/radarr/faq#radarr-runs-under-the-localservice-account-by-default-which-doesnt-have-access-to-protected-remote-file-shares)
    - [You're using a mapped network drive (not a UNC path)](https://wiki.servarr.com/radarr/faq#youre-using-a-mapped-network-drive-not-a-unc-path)
  - [How do I change from the Windows Service to a Tray App?](https://wiki.servarr.com/radarr/faq#how-do-i-change-from-the-windows-service-to-a-tray-app)
  - [Help I have locked myself out](https://wiki.servarr.com/radarr/faq#help-i-have-locked-myself-out)
  - [How do I stop the browser from launching on startup?](https://wiki.servarr.com/radarr/faq#how-do-i-stop-the-browser-from-launching-on-startup)
  - [Weird UI Issues](https://wiki.servarr.com/radarr/faq#weird-ui-issues)
  - [Web Interface Only Loads at localhost on Windows](https://wiki.servarr.com/radarr/faq#web-interface-only-loads-at-localhost-on-windows)
  - [Permissions](https://wiki.servarr.com/radarr/faq#permissions)
  - [System & Logs loads forever](https://wiki.servarr.com/radarr/faq#system-logs-loads-forever)
  - [Unpack Torrents](https://wiki.servarr.com/radarr/faq#unpack-torrents)
  - [I got a pop-up that said config.xml was corrupt, what now?](https://wiki.servarr.com/radarr/faq#i-got-a-pop-up-that-said-configxml-was-corrupt-what-now)
  - [Invalid Certificate and other HTTPS or SSL issues](https://wiki.servarr.com/radarr/faq#invalid-certificate-and-other-https-or-ssl-issues)
  - [VPNs, Jackett, and the \*ARRs](https://wiki.servarr.com/radarr/faq#vpns-jackett-and-the-arrs)
    - [Use of a VPN](https://wiki.servarr.com/radarr/faq#use-of-a-vpn)
- [Radarr Searching & Downloading Common Problems](https://wiki.servarr.com/radarr/faq#radarr-searching--downloading-common-problems)
  - [Why can I not add a new movie to Radarr?](https://wiki.servarr.com/radarr/faq#why-can-i-not-add-a-new-movie-to-radarr)
  - [What is this new " _Override and add to download queue_" button?](https://wiki.servarr.com/radarr/faq#what-is-this-new-override-and-add-to-download-queue-button)
  - [Jackett shows more results than when manually searching](https://wiki.servarr.com/radarr/faq#jackett-shows-more-results-than-when-manually-searching)
  - [How does Radarr determine the year of a movie?](https://wiki.servarr.com/radarr/faq#how-does-radarr-determine-the-year-of-a-movie)
  - [How does Radarr handle foreign movies or foreign titles?](https://wiki.servarr.com/radarr/faq#how-does-radarr-handle-foreign-movies-or-foreign-titles)
  - [ID Searches](https://wiki.servarr.com/radarr/faq#id-searches)
  - [Text Searches](https://wiki.servarr.com/radarr/faq#text-searches)
  - [Getting Foreign Movies](https://wiki.servarr.com/radarr/faq#getting-foreign-movies)
  - [How does Radarr handle "multi" in names?](https://wiki.servarr.com/radarr/faq#how-does-radarr-handle-multi-in-names)
  - [Help, Movie Added, But Not Searched](https://wiki.servarr.com/radarr/faq#help-movie-added-but-not-searched)
  - [Jackett's /all Endpoint](https://wiki.servarr.com/radarr/faq#jacketts-all-endpoint)
    - [Jackett /All Solutions](https://wiki.servarr.com/radarr/faq#jackett-all-solutions)
  - [Why are there two files? \| Why is there a file left in downloads?](https://wiki.servarr.com/radarr/faq#why-are-there-two-files--why-is-there-a-file-left-in-downloads)
  - [Why doesn't Radarr work behind a reverse proxy](https://wiki.servarr.com/radarr/faq#why-doesnt-radarr-work-behind-a-reverse-proxy)

# [¶](https://wiki.servarr.com/radarr/faq\#radarr-basics) Radarr Basics

## [¶](https://wiki.servarr.com/radarr/faq\#how-does-radarr-work) How does Radarr work

- Radarr does _not_ regularly search for movie files that are missing or have not met their quality goals. Instead, it fairly frequently queries your indexers and trackers for _all_ the newly posted movies, then compares that with its list of movies that are missing or need to be upgraded. Any matches are downloaded. This lets Radarr cover a library of _any size_ with just 24-100 queries per day (RSS interval of 15-60 minutes). If you understand this, you will realize that it only covers the _future_ though.
...
- If you've already added the movie, but now you want to search for it, you have a few choices. You can go to the movie's page and use the search button, which will do a search and then automatically pick one. You can use the Search tab and see _all_ the results, hand picking the one you want. Or you can use the filters of `Missing`, `Wanted`, or `Cut-off Unmet`.
...
> Upgradinatorr can do periodic bulk searches which is useful to safely and sanely look for upgrades after major changes to one's quality profile. Use [Drazzlib's Python Script](https://wiki.servarr.com/useful-tools#drazzilbs-userscripts) or [Cuban's Powershell Script](https://wiki.servarr.com/useful-tools#just-a-bunch-of-starr-scripts)

## [¶](https://wiki.servarr.com/radarr/faq\#how-does-radarr-find-movies) How does Radarr find movies

> This FAQ item is a legacy FAQ Entry. Refer to [How does Radarr work?](https://wiki.servarr.com/radarr/faq#how-does-radarr-work)

## [¶](https://wiki.servarr.com/radarr/faq\#how-do-i-access-radarr-from-another-computer) How do I access Radarr from another computer
...
## [¶](https://wiki.servarr.com/radarr/faq\#forced-authentication) Forced Authentication
...
### [¶](https://wiki.servarr.com/radarr/faq\#authentication-method) Authentication Method
...
- `External`\- Configurable via Config File Only
  ...
  - Disables app authentication completely. _Use at your own risk especially if exposed to the internet_ Suggested if you use an **external authentication** such as Authelia, Authetik, NGINX Basic auth, etc. you can prevent needing to double authenticate by shutting down the app, setting `<AuthenticationMethod>External</AuthenticationMethod>` in the [config file](https://wiki.servarr.com/radarr/appdata-directory), and restarting the app. **Note that multiple `AuthenticationMethod` entries in the file are not supported and only the topmost value will be used**
...
### [¶](https://wiki.servarr.com/radarr/faq\#authentication-required) Authentication Required
...
## [¶](https://wiki.servarr.com/radarr/faq\#what-is-minimum-availability) What is Minimum Availability

> For More Information on TMDB's Dates that impact the below Availabilities See [How Does Radarr Determine the Year of the Movie](https://wiki.servarr.com/radarr/faq#how-does-radarr-determine-the-year-of-a-movie)
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-are-possible-downloads-compared) How are possible downloads compared
...
> \*REPACKS and PROPERs are v2 of Qualities and thus rank above a non-repack of the same quality. [Set Media Management => File Management `Download Proper & Repacks` "Do Not Prefer"](https://wiki.servarr.com/radarr/settings#file-management) and use the [Repack/Proper Custom Format](https://trash-guides.info/Radarr/Radarr-collection-of-custom-formats/#repack-proper).

## [¶](https://wiki.servarr.com/radarr/faq\#what-are-lists-and-what-can-they-do-for-me) What are Lists and what can they do for me
...
### [¶](https://wiki.servarr.com/radarr/faq\#why-are-lists-sync-times-so-long-and-can-i-change-it) Why are lists sync times so long and can I change it
...
- In Radarr pre-v4.7 interval can be configured in [Settings => Lists](https://wiki.servarr.com/radarr/settings#lists) for between 6-24 hours. The default is 24 hours.
...
## [¶](https://wiki.servarr.com/radarr/faq\#can-all-my-movie-files-be-stored-in-one-folder) Can all my movie files be stored in one folder

- No. Radarr is a fork of [Sonarr](https://wiki.servarr.com/sonarr) and thus requires that each movie be stored in individual folders. It is **highly unlikely** a flat file structure would ever be supported due to substantial backend modifications required.
...
- For information on how to move your movies from a single folder to separate folders, refer to the [Tips and Tricks Section => Create a Folder for Each Movie](https://wiki.servarr.com/radarr/tips-and-tricks#creating-a-folder-for-each-movie).

## [¶](https://wiki.servarr.com/radarr/faq\#can-i-put-all-my-movies-in-my-library-into-one-folder) Can I put all my movies in my library into one folder

- No, see above.

## [¶](https://wiki.servarr.com/radarr/faq\#how-do-i-update-radarr) How do I update Radarr
...
### [¶](https://wiki.servarr.com/radarr/faq\#can-i-update-radarr-inside-my-docker-container) Can I update Radarr inside my Docker container
...
### [¶](https://wiki.servarr.com/radarr/faq\#installing-a-newer-version) Installing a newer version

#### [¶](https://wiki.servarr.com/radarr/faq\#native) Native
...
#### [¶](https://wiki.servarr.com/radarr/faq\#docker) Docker

1. Repull your tag and update your container

## [¶](https://wiki.servarr.com/radarr/faq\#can-i-switch-from-nightly-back-to-develop) Can I switch from `nightly` back to `develop`

## [¶](https://wiki.servarr.com/radarr/faq\#can-i-switch-between-branches) Can I switch between branches
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-do-i-backuprestore-radarr) How do I Backup/Restore Radarr

### [¶](https://wiki.servarr.com/radarr/faq\#backing-up-radarr) Backing up Radarr

#### [¶](https://wiki.servarr.com/radarr/faq\#using-built-in-backup) Using built-in backup

- Go to System => Backup in the Radarr UI
- Click the Backup button
- Download the zip after the backup is created for safekeeping

#### [¶](https://wiki.servarr.com/radarr/faq\#using-file-system-directly) Using file system directly

- Find the location of the AppData directory for Radarr
  - Via the Radarr UI go to System => About
  - [Radarr Appdata Directory](https://wiki.servarr.com/radarr/appdata-directory)
- Stop Radarr - This will prevent the database from being corrupted
- Copy the contents to a safe location

### [¶](https://wiki.servarr.com/radarr/faq\#restoring-from-backup) Restoring from Backup
...
#### [¶](https://wiki.servarr.com/radarr/faq\#using-zip-backup) Using zip backup
...
#### [¶](https://wiki.servarr.com/radarr/faq\#using-file-system-backup) Using file system backup
...
#### [¶](https://wiki.servarr.com/radarr/faq\#file-system-restore-on-synology-nas) File System Restore on Synology NAS
...
# [¶](https://wiki.servarr.com/radarr/faq\#radarr-common-problems) Radarr Common Problems

## [¶](https://wiki.servarr.com/radarr/faq\#a-task-was-canceled) A Task was Canceled
...
- This is often caused by:
  ...
  - local IPv6 issues - _most common_ \- typically IPv6 is enabled on the host system, but non-functional
...
## [¶](https://wiki.servarr.com/radarr/faq\#path-is-already-configured-for-an-existing-movie) Path is Already Configured for an Existing Movie

![existing-movie.png](https://wiki.servarr.com/assets/radarr/existing-movie.png)
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-can-i-rename-my-movie-folders) How can I rename my movie folders
...
## [¶](https://wiki.servarr.com/radarr/faq\#movie-file-and-folder-naming) Movie File and Folder Naming
...
- See [Tips and Tricks Section => Create a Folder for Each Movie](https://wiki.servarr.com/radarr/faq) radarr/tips-and-tricks#creating-a-folder-for-each-movie) for more details.


## [¶](https://wiki.servarr.com/radarr/faq\#movie-folders-named-incorrectly) Movie Folders Named Incorrectly
...
- Even if your movies are in folders already, the folders may not be named correctly. The folder name should be `Movie Title (Year)`, having the title and year in the folder’s name is critical right now.
  ...
  - The [Tips and Tricks Section => Create a Folder for Each Movie](https://wiki.servarr.com/radarr/tips-and-tricks#creating-a-folder-for-each-movie) is a great source for making sure your file and folder structure will work great.

## [¶](https://wiki.servarr.com/radarr/faq\#can-i-disable-the-refresh-movies-task) Can I disable the refresh movies task
...
## [¶](https://wiki.servarr.com/radarr/faq\#found-matching-movie-via-grab-history-but-release-was-matched-to-movie-by-id-manual-import-required) Found matching movie via grab history, but release was matched to movie by ID. Manual Import required
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-do-i-request-a-feature-for-radarr) How do I request a feature for Radarr

- This is an easy one [visit the Radarr GitHub issues page](https://github.com/Radarr/Radarr/issues)

## [¶](https://wiki.servarr.com/radarr/faq\#help-my-mac-says-radarr-cannot-be-opened-because-the-developer-cannot-be-verified) Help, My Mac says Radarr cannot be opened because the developer cannot be verified

- This is simple, please see this link for more information [in the Mac help documentation](https://support.apple.com/guide/mac-help/open-a-mac-app-from-an-unidentified-developer-mh40616/mac)![Developer Cannot be verified](https://wiki.servarr.com/radarr/developer-cannot-be-verified.png)
...
## [¶](https://wiki.servarr.com/radarr/faq\#help-my-mac-says-radarrapp-is-damaged-and-cant-be-opened) Help, My Mac says Radarr.app is damaged and can’t be opened

- That is either due to a corrupt download so try again or [security issues, please see this related FAQ entry.](https://wiki.servarr.com/radarr/faq#help-my-mac-says-radarr-cannot-be-opened-because-the-developer-cannot-be-verified)

## [¶](https://wiki.servarr.com/radarr/faq\#i-am-getting-an-error-database-disk-image-is-malformed) I am getting an error: Database disk image is malformed
...
- Your best and first option is to [try restoring from a backup](https://wiki.servarr.com/radarr/faq#how-do-i-backuprestore-my-radarr). However, for users receiving this after upgrading to v4 it is highly unlikely the backup itself will work and you'll need to try the other recovery methods mentioned.
...
## [¶](https://wiki.servarr.com/radarr/faq\#i-use-radarr-on-a-mac-and-it-suddenly-stopped-working-what-happened) I use Radarr on a Mac and it suddenly stopped working. What happened
...
## [¶](https://wiki.servarr.com/radarr/faq\#radarr-wont-start-on-debian-11-or-older-systems-due-to-sqlite-version) Radarr won't start on Debian 11 or older systems due to SQLite version
...
### [¶](https://wiki.servarr.com/radarr/faq\#solution) Solution
...
### [¶](https://wiki.servarr.com/radarr/faq\#when-to-use-this-workaround) When to use this workaround
...
### [¶](https://wiki.servarr.com/radarr/faq\#when-not-to-use-this-workaround) When NOT to use this workaround
...
## [¶](https://wiki.servarr.com/radarr/faq\#why-can-radarr-not-see-my-files-on-a-remote-server) Why can Radarr not see my files on a remote server
...
### [¶](https://wiki.servarr.com/radarr/faq\#radarr-runs-under-the-localservice-account-by-default-which-doesnt-have-access-to-protected-remote-file-shares) Radarr runs under the LocalService account by default which doesn't have access to protected remote file shares
...
### [¶](https://wiki.servarr.com/radarr/faq\#youre-using-a-mapped-network-drive-not-a-unc-path) You're using a mapped network drive (not a UNC path)

- Change your paths to UNC paths (`\\server\share`)
- Run Radarr.exe via the Startup Folder

## [¶](https://wiki.servarr.com/radarr/faq\#how-do-i-change-from-the-windows-service-to-a-tray-app) How do I change from the Windows Service to a Tray App
...
## [¶](https://wiki.servarr.com/radarr/faq\#help-i-have-locked-myself-out) Help I have locked myself out

To disable authentication (to reset your forgotten username or password) you will need need to edit `config.xml` which will be inside the [Radarr Appdata Directory](https://wiki.servarr.com/radarr/appdata-directory)
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-do-i-stop-the-browser-from-launching-on-startup) How do I stop the browser from launching on startup
...
## [¶](https://wiki.servarr.com/radarr/faq\#weird-ui-issues) Weird UI Issues
...
## [¶](https://wiki.servarr.com/radarr/faq\#web-interface-only-loads-at-localhost-on-windows) Web Interface Only Loads at localhost on Windows

- If you can only reach your web interface at [http://localhost:7878/](http://localhost:7878/) or [http://127.0.0.1:7878/](http://127.0.0.1:7878/), you need to run as administrator at least once.

## [¶](https://wiki.servarr.com/radarr/faq\#permissions) Permissions
...
## [¶](https://wiki.servarr.com/radarr/faq\#system-logs-loads-forever) System & Logs loads forever
...
## [¶](https://wiki.servarr.com/radarr/faq\#unpack-torrents) Unpack Torrents
...
## [¶](https://wiki.servarr.com/radarr/faq\#i-got-a-pop-up-that-said-configxml-was-corrupt-what-now) I got a pop-up that said config.xml was corrupt, what now

- Radarr was unable to read your config file on start-up as it became corrupted somehow. In order to get back online, you will need to delete `.xml` in your [appdata-directory](https://wiki.servarr.com/radarr/appdata-directory), once deleted start and it will start on the default port (7878), you should now re-configure any settings you configured on the General Settings page.

## [¶](https://wiki.servarr.com/radarr/faq\#invalid-certificate-and-other-https-or-ssl-issues) Invalid Certificate and other HTTPS or SSL issues
...
## [¶](https://wiki.servarr.com/radarr/faq\#vpns-jackett-and-the-arrs) VPNs, Jackett, and the \*ARRs
...
### [¶](https://wiki.servarr.com/radarr/faq\#use-of-a-vpn) Use of a VPN
...
# [¶](https://wiki.servarr.com/radarr/faq\#radarr-searching-downloading-common-problems) Radarr Searching & Downloading Common Problems

## [¶](https://wiki.servarr.com/radarr/faq\#why-can-i-not-add-a-new-movie-to-radarr) Why can I not add a new movie to Radarr
...
## [¶](https://wiki.servarr.com/radarr/faq\#what-is-this-new-override-and-add-to-download-queue-button) What is this new " _Override and add to download queue_" button
...
## [¶](https://wiki.servarr.com/radarr/faq\#jackett-shows-more-results-than-when-manually-searching) Jackett shows more results than when manually searching

- This is usually due to searching Jackett differently than you do. See our [troubleshooting article](https://wiki.servarr.com/radarr/troubleshooting) for more information.

## [¶](https://wiki.servarr.com/radarr/faq\#how-does-radarr-determine-the-year-of-a-movie) How does Radarr determine the year of a movie
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-does-radarr-handle-foreign-movies-or-foreign-titles) How does Radarr handle foreign movies or foreign titles
...
- _\*the [original language field should contain the main language spoken by the production companies.](https://www.themoviedb.org/talk/646c7179a5046e00e5b7cd4c#647239a9dd731b00ddf07fd1)_

## [¶](https://wiki.servarr.com/radarr/faq\#id-searches) ID Searches
...
## [¶](https://wiki.servarr.com/radarr/faq\#text-searches) Text Searches
...
## [¶](https://wiki.servarr.com/radarr/faq\#getting-foreign-movies) Getting Foreign Movies
...
## [¶](https://wiki.servarr.com/radarr/faq\#how-does-radarr-handle-multi-in-names) How does Radarr handle "multi" in names
...
## [¶](https://wiki.servarr.com/radarr/faq\#help-movie-added-but-not-searched) Help, Movie Added, But Not Searched

- Radarr does not _actively_ search for missing movies automatically. Instead, a periodic query of new posts is made to all indexers configured for RSS. When a wanted or cutoff unmet movie shows up in that list, it gets downloaded. This means that until a movie is posted (or reposted), it won’t get downloaded.

- If you’re adding a movie that you want now, the best option is to check the “Start search for missing movie” box, to the left of the _Add Movie_ ( **1**) button. You can also go to the page for a movie you’ve added and click the magnifying glass “Search” ( **2**) button or use the Wanted view to search for Missing or Cutoff Unmet movies.

  - Add and Search for Movie when adding a movie

    ![addmovie-add-and-search.png](https://wiki.servarr.com/assets/radarr/addmovie-add-and-search.png)
  - Search an existing Movie

    ![searchmovie-movie-page.png](https://wiki.servarr.com/assets/radarr/searchmovie-movie-page.png)

## [¶](https://wiki.servarr.com/radarr/faq\#jacketts-all-endpoint) Jackett's /all Endpoint
...
### [¶](https://wiki.servarr.com/radarr/faq\#jackett-all-solutions) Jackett /All Solutions
...
## [¶](https://wiki.servarr.com/radarr/faq\#why-are-there-two-files-why-is-there-a-file-left-in-downloads) Why are there two files? \| Why is there a file left in downloads
...
## [¶](https://wiki.servarr.com/radarr/faq\#why-doesnt-radarr-work-behind-a-reverse-proxy) Why doesn't Radarr work behind a reverse proxy
