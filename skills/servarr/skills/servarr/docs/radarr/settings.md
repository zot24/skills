<!-- Source: https://wiki.servarr.com/radarr/settings -->

* * *

Radarr Settings

Description of Radarr's Settings Menus
...
[radarr](https://wiki.servarr.com/t/radarr) [settings](https://wiki.servarr.com/t/settings) [indexers](https://wiki.servarr.com/t/indexers) [configuration](https://wiki.servarr.com/t/configuration) [quality](https://wiki.servarr.com/t/quality) [profiles](https://wiki.servarr.com/t/profiles) [Pages matching tags](https://wiki.servarr.com/t/radarr/settings/indexers/configuration/quality/profiles)
...
# [¶](https://wiki.servarr.com/radarr/settings\#table-of-contents) Table of Contents

- [Table of Contents](https://wiki.servarr.com/radarr/settings#table-of-contents)
- [Menu options](https://wiki.servarr.com/radarr/settings#menu-options)
- [Media Management](https://wiki.servarr.com/radarr/settings#media-management)
  - [Community Naming Suggestions](https://wiki.servarr.com/radarr/settings#community-naming-suggestions)
    - [Movie Files](https://wiki.servarr.com/radarr/settings#movie-files)
    - [Movie Folders](https://wiki.servarr.com/radarr/settings#movie-folders)
  - [Movie Naming](https://wiki.servarr.com/radarr/settings#movie-naming)
    - [Standard Movie Format](https://wiki.servarr.com/radarr/settings#standard-movie-format)
    - [Movie Naming](https://wiki.servarr.com/radarr/settings#movie-naming-1)
    - [Movie IDs](https://wiki.servarr.com/radarr/settings#movie-ids)
    - [Quality](https://wiki.servarr.com/radarr/settings#quality)
    - [Media Info](https://wiki.servarr.com/radarr/settings#media-info)
    - [Release Group](https://wiki.servarr.com/radarr/settings#release-group)
    - [Edition](https://wiki.servarr.com/radarr/settings#edition)
    - [Custom Formats (Naming)](https://wiki.servarr.com/radarr/settings#custom-formats-naming)
    - [Original](https://wiki.servarr.com/radarr/settings#original)
  - [Movie Folder Format](https://wiki.servarr.com/radarr/settings#movie-folder-format)
    - [Movie Naming](https://wiki.servarr.com/radarr/settings#movie-naming-2)
    - [Movie ID](https://wiki.servarr.com/radarr/settings#movie-id)
  - [Folders](https://wiki.servarr.com/radarr/settings#folders)
  - [Importing](https://wiki.servarr.com/radarr/settings#importing)
  - [File Management](https://wiki.servarr.com/radarr/settings#file-management)
  - [Permissions](https://wiki.servarr.com/radarr/settings#permissions)
  - [Root Folders](https://wiki.servarr.com/radarr/settings#root-folders)
- [Profiles](https://wiki.servarr.com/radarr/settings#profiles)
  - [Quality Profiles](https://wiki.servarr.com/radarr/settings#quality-profiles)
  - [Delay Profiles](https://wiki.servarr.com/radarr/settings#delay-profiles)
    - [Uses](https://wiki.servarr.com/radarr/settings#uses)
    - [How Delay Profiles Work](https://wiki.servarr.com/radarr/settings#how-delay-profiles-work)
      - [Examples](https://wiki.servarr.com/radarr/settings#examples)
        - [Example 1](https://wiki.servarr.com/radarr/settings#example-1)
        - [Example 2](https://wiki.servarr.com/radarr/settings#example-2)
        - [Example 3](https://wiki.servarr.com/radarr/settings#example-3)
  - [Release Profiles](https://wiki.servarr.com/radarr/settings#release-profiles)
- [Quality](https://wiki.servarr.com/radarr/settings#quality-1)
  - [Quality Table Meanings](https://wiki.servarr.com/radarr/settings#quality-table-meanings)
  - [Qualities Defined](https://wiki.servarr.com/radarr/settings#qualities-defined)
- [Custom Formats](https://wiki.servarr.com/radarr/settings#custom-formats)
  - [Custom Format Conditions](https://wiki.servarr.com/radarr/settings#custom-format-conditions)
    - [Modifiers](https://wiki.servarr.com/radarr/settings#modifiers)
    - [Conditions](https://wiki.servarr.com/radarr/settings#conditions)
    - [Profiling Settings and Ranking](https://wiki.servarr.com/radarr/settings#profiling-settings-and-ranking)
      - [Importing / Exporting Custom Formats](https://wiki.servarr.com/radarr/settings#importing--exporting-custom-formats)
      - [Importing / Updating Existing Custom Formats](https://wiki.servarr.com/radarr/settings#importing--updating-existing-custom-formats)
    - [Collection of Custom Formats](https://wiki.servarr.com/radarr/settings#collection-of-custom-formats)
- [Indexers](https://wiki.servarr.com/radarr/settings#indexers)
  - [Supported Indexers](https://wiki.servarr.com/radarr/settings#supported-indexers)
    - [Indexer Settings](https://wiki.servarr.com/radarr/settings#indexer-settings)
    - [Usenet Indexer Configuration](https://wiki.servarr.com/radarr/settings#usenet-indexer-configuration)
    - [Torrent Tracker Configuration](https://wiki.servarr.com/radarr/settings#torrent-tracker-configuration)
      - [Indexer Flags](https://wiki.servarr.com/radarr/settings#indexer-flags)
  - [Options](https://wiki.servarr.com/radarr/settings#options)
- [Download Clients](https://wiki.servarr.com/radarr/settings#download-clients)
  - [Overview](https://wiki.servarr.com/radarr/settings#overview)
  - [Download Client Processes](https://wiki.servarr.com/radarr/settings#download-client-processes)
    - [Usenet Process](https://wiki.servarr.com/radarr/settings#usenet-process)
    - [Torrent Process](https://wiki.servarr.com/radarr/settings#torrent-process)
  - [Download Clients](https://wiki.servarr.com/radarr/settings#download-clients-1)
    - [Supported Download Clients](https://wiki.servarr.com/radarr/settings#supported-download-clients)
    - [Usenet Client Settings](https://wiki.servarr.com/radarr/settings#usenet-client-settings)
    - [Torrent Client Settings](https://wiki.servarr.com/radarr/settings#torrent-client-settings)
    - [Torrent Client Remove Download Compatibility](https://wiki.servarr.com/radarr/settings#torrent-client-remove-download-compatibility)
  - [Completed Download Handling](https://wiki.servarr.com/radarr/settings#completed-download-handling)
    - [Remove Completed Downloads](https://wiki.servarr.com/radarr/settings#remove-completed-downloads)
    - [Failed Download Handling](https://wiki.servarr.com/radarr/settings#failed-download-handling)
  - [Remote Path Mappings](https://wiki.servarr.com/radarr/settings#remote-path-mappings)
- [Import Lists](https://wiki.servarr.com/radarr/settings#import-lists)
  - [Lists](https://wiki.servarr.com/radarr/settings#lists)
  - [List Options](https://wiki.servarr.com/radarr/settings#list-options)
  - [List Exclusions](https://wiki.servarr.com/radarr/settings#list-exclusions)
- [Connect](https://wiki.servarr.com/radarr/settings#connect)
  - [Connections](https://wiki.servarr.com/radarr/settings#connections)
  - [Connection Triggers](https://wiki.servarr.com/radarr/settings#connection-triggers)
- [Metadata](https://wiki.servarr.com/radarr/settings#metadata)
  - [Options](https://wiki.servarr.com/radarr/settings#options-1)
  - [Metadata Consumers](https://wiki.servarr.com/radarr/settings#metadata-consumers)
- [Tags](https://wiki.servarr.com/radarr/settings#tags)
- [General](https://wiki.servarr.com/radarr/settings#general)
  - [Host](https://wiki.servarr.com/radarr/settings#host)
  - [Security](https://wiki.servarr.com/radarr/settings#security)
  - [Proxy](https://wiki.servarr.com/radarr/settings#proxy)
  - [Logging](https://wiki.servarr.com/radarr/settings#logging)
  - [Analytics](https://wiki.servarr.com/radarr/settings#analytics)
  - [Updates](https://wiki.servarr.com/radarr/settings#updates)
  - [Backups](https://wiki.servarr.com/radarr/settings#backups)
- [UI](https://wiki.servarr.com/radarr/settings#ui)
  - [Calendar](https://wiki.servarr.com/radarr/settings#calendar)
  - [Movies](https://wiki.servarr.com/radarr/settings#movies)
  - [Dates](https://wiki.servarr.com/radarr/settings#dates)
  - [Style](https://wiki.servarr.com/radarr/settings#style)
  - [Language](https://wiki.servarr.com/radarr/settings#language)

This page will go through all the settings available in Radarr and how they work. This is not meant to be a comprehensive "how to set up Radarr." If you want that, please use the [Quick Start](https://wiki.servarr.com/radarr/quick-start-guide) page instead.

# [¶](https://wiki.servarr.com/radarr/settings\#menu-options) Menu options

To get to the Settings page, choose Settings from the sidebar. The following sub-menu options will be available:

![settings_1_menu.png](https://wiki.servarr.com/assets/radarr/settings_1_menu.png)

Also, note that for each individual settings page, there are some options at the top of the menu:

![settings_2_topmenu.png](https://wiki.servarr.com/assets/radarr/settings_2_topmenu.png)
...
# [¶](https://wiki.servarr.com/radarr/settings\#media-management) Media Management

> Some of these settings are only visible through `Show Advanced Settings` which is on the top bar under the search bar

## [¶](https://wiki.servarr.com/radarr/settings\#community-naming-suggestions) Community Naming Suggestions
...
### [¶](https://wiki.servarr.com/radarr/settings\#movie-files) Movie Files

- Radarr v4.2.2.6489 or newer

`{Movie CleanTitle} {(Release Year)} {imdb-{ImdbId}} {edition-{Edition Tags}} {[Custom Formats]}{[Quality Full]}{[MediaInfo 3D]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[Mediainfo VideoCodec]}{-Release Group}`

### [¶](https://wiki.servarr.com/radarr/settings\#movie-folders) Movie Folders

`{Movie CleanTitle} ({Release Year})`

## [¶](https://wiki.servarr.com/radarr/settings\#movie-naming) Movie Naming
...
### [¶](https://wiki.servarr.com/radarr/settings\#standard-movie-format) Standard Movie Format
...
### [¶](https://wiki.servarr.com/radarr/settings\#movie-naming-1) Movie Naming
...
### [¶](https://wiki.servarr.com/radarr/settings\#movie-ids) Movie IDs
...
### [¶](https://wiki.servarr.com/radarr/settings\#quality) Quality

- `{Quality Full}` = HDTV 720p Proper
- `{Quality Title}` = HDTV 720p

### [¶](https://wiki.servarr.com/radarr/settings\#media-info) Media Info
...
### [¶](https://wiki.servarr.com/radarr/settings\#release-group) Release Group

- `{Release Group}` = Rls Grp

### [¶](https://wiki.servarr.com/radarr/settings\#edition) Edition
...
### [¶](https://wiki.servarr.com/radarr/settings\#custom-formats-naming) Custom Formats (Naming)
...
### [¶](https://wiki.servarr.com/radarr/settings\#original) Original
...
## [¶](https://wiki.servarr.com/radarr/settings\#movie-folder-format) Movie Folder Format
...
### [¶](https://wiki.servarr.com/radarr/settings\#movie-naming-2) Movie Naming
...
### [¶](https://wiki.servarr.com/radarr/settings\#movie-id) Movie ID

- `{ImdbId}` = tt12345
- `{Tmdbid}` = 123456

## [¶](https://wiki.servarr.com/radarr/settings\#folders) Folders
...
## [¶](https://wiki.servarr.com/radarr/settings\#importing) Importing
...
## [¶](https://wiki.servarr.com/radarr/settings\#file-management) File Management
...
- Download Proper & Repacks - Whether or not to automatically upgrade to Propers/Repacks. Use `Do not Prefer` to sort by preferred word score over propers/repacks
  ...
  - Do Not Prefer - Effectively this ignores repacks and propers. You'll need to manage any preference for those with [Custom Formats](https://wiki.servarr.com/radarr/settings#custom-formats).
...
## [¶](https://wiki.servarr.com/radarr/settings\#permissions) Permissions
...
## [¶](https://wiki.servarr.com/radarr/settings\#root-folders) Root Folders
...
# [¶](https://wiki.servarr.com/radarr/settings\#profiles) Profiles

## [¶](https://wiki.servarr.com/radarr/settings\#quality-profiles) Quality Profiles
...
- Upgrades Allowed - When this option is checked and you tell Radarr to download a `WEB 1080p` as it is the first release of a specific movie then later somebody is able to upload a `Bluray-1080p` Radarr will automatically upgrade to the better quality _**if**_`Upgrade Until` has that quality selected
...
- Qualities - Qualities higher in the list are more preferred even if not checked. Qualities within the same group are equal. Only checked qualities are wanted.
  ...
  - [See Qualities](https://wiki.servarr.com/radarr/settings#qualities-defined)
...
See [Custom Formats](https://wiki.servarr.com/radarr/settings#custom-formats) for more details.


## [¶](https://wiki.servarr.com/radarr/settings\#delay-profiles) Delay Profiles
...
### [¶](https://wiki.servarr.com/radarr/settings\#uses) Uses
...
### [¶](https://wiki.servarr.com/radarr/settings\#how-delay-profiles-work) How Delay Profiles Work
...
#### [¶](https://wiki.servarr.com/radarr/settings\#examples) Examples
...
##### [¶](https://wiki.servarr.com/radarr/settings\#example-1) Example 1
...
##### [¶](https://wiki.servarr.com/radarr/settings\#example-2) Example 2
...
##### [¶](https://wiki.servarr.com/radarr/settings\#example-3) Example 3
...
## [¶](https://wiki.servarr.com/radarr/settings\#release-profiles) Release Profiles
...
- Tags - Here you can apply these settings to movies with at least one of the given [tag](https://wiki.servarr.com/radarr/settings#tags).

# [¶](https://wiki.servarr.com/radarr/settings\#quality-1) Quality

## [¶](https://wiki.servarr.com/radarr/settings\#quality-table-meanings) Quality Table Meanings
...
## [¶](https://wiki.servarr.com/radarr/settings\#qualities-defined) Qualities Defined
...
# [¶](https://wiki.servarr.com/radarr/settings\#custom-formats) Custom Formats
...
## [¶](https://wiki.servarr.com/radarr/settings\#custom-format-conditions) Custom Format Conditions

### [¶](https://wiki.servarr.com/radarr/settings\#modifiers) Modifiers
...
### [¶](https://wiki.servarr.com/radarr/settings\#conditions) Conditions
...
- [Indexer Flag](https://wiki.servarr.com/radarr/settings#indexer-flags) \- This tag is matched against any Indexer Flags that Radarr may parse.
...
### [¶](https://wiki.servarr.com/radarr/settings\#profiling-settings-and-ranking) Profiling Settings and Ranking
...
#### [¶](https://wiki.servarr.com/radarr/settings\#importing-exporting-custom-formats) Importing / Exporting Custom Formats
...
#### [¶](https://wiki.servarr.com/radarr/settings\#importing-updating-existing-custom-formats) Importing / Updating Existing Custom Formats
...
### [¶](https://wiki.servarr.com/radarr/settings\#collection-of-custom-formats) Collection of Custom Formats

- [TRaSH maintains a collection of custom formats](https://trash-guides.info/Radarr/Radarr-collection-of-custom-formats/)

# [¶](https://wiki.servarr.com/radarr/settings\#indexers) Indexers

> Information on supported indexers can be found at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#indexers) page for this section

## [¶](https://wiki.servarr.com/radarr/settings\#supported-indexers) Supported Indexers

- A list of supported indexers is located at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#indexers) page

### [¶](https://wiki.servarr.com/radarr/settings\#indexer-settings) Indexer Settings
...
### [¶](https://wiki.servarr.com/radarr/settings\#usenet-indexer-configuration) Usenet Indexer Configuration
...
- Software that works with usenet and integrates quite well with Radarr are [NZBHydra2](https://github.com/theotherp/nzbhydra2/) or [Prowlarr](https://wiki.servarr.com/prowlarr) which integrate with both Usenet and Torrents
...
### [¶](https://wiki.servarr.com/radarr/settings\#torrent-tracker-configuration) Torrent Tracker Configuration
...
- One of the best and simplest ways to utilize Torrent trackers that are not natively supported with Radarr is to utilize a second program such as [Prowlarr](https://wiki.servarr.com/prowlarr) or [Jackett](https://github.com/Jackett/Jackett). These software pair well with Radarr as a search indexer that houses all your information and sends it to Radarr.
...
#### [¶](https://wiki.servarr.com/radarr/settings\#indexer-flags) Indexer Flags
...
## [¶](https://wiki.servarr.com/radarr/settings\#options) Options
...
- RSS Sync interval - Interval in minutes. Set to zero to disable (this will stop all automatic release grabbing) Minimum: 10 minutes Maximum: 120 minutes
  - Please see [How does Radarr find movies?](https://wiki.servarr.com/radarr/faq#how-does-radarr-find-movies) for a better understanding of how RSS Sync will help you
...
# [¶](https://wiki.servarr.com/radarr/settings\#download-clients) Download Clients

> Information on supported download clients can be found at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#download-clients) page for this section

## [¶](https://wiki.servarr.com/radarr/settings\#overview) Overview

- Downloading and importing is where most people experience issues. From a high level perspective, the software needs to be able to communicate with your download client and have access to the files it downloads. There is a large variety of supported download clients and an even bigger variety of setups. This means that while there are some common setups there isn't one right setup and everyone's setup can be a little different. But there are many wrong setups.

## [¶](https://wiki.servarr.com/radarr/settings\#download-client-processes) Download Client Processes

### [¶](https://wiki.servarr.com/radarr/settings\#usenet-process) Usenet Process
...
### [¶](https://wiki.servarr.com/radarr/settings\#torrent-process) Torrent Process
...
## [¶](https://wiki.servarr.com/radarr/settings\#download-clients-1) Download Clients
...
### [¶](https://wiki.servarr.com/radarr/settings\#supported-download-clients) Supported Download Clients

- A list of supported download clients is located at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#download-clients) page

Select the download client you wish to add, and there will be a pop-up box to enter connection details. These details are similar for most clients. Some will ask for a username or password, some will ask for whether to add new downloads in a paused/start state, etc.

### [¶](https://wiki.servarr.com/radarr/settings\#usenet-client-settings) Usenet Client Settings
...
- Completed Download Handling
  - Remove (Per Client Setting) - Remove completed downloads when finished (usenet) or stopped/complete (torrents). See [Completed Download Handling for more details](https://wiki.servarr.com/radarr/settings#completed-download-handling)

### [¶](https://wiki.servarr.com/radarr/settings\#torrent-client-settings) Torrent Client Settings
...
### [¶](https://wiki.servarr.com/radarr/settings\#torrent-client-remove-download-compatibility) Torrent Client Remove Download Compatibility
...
| Client | Ratio | Time |
| --- | --- | --- |
| Aria2 | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) |
| Deluge | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) |
| Download Station | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) |
| Flood | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) |
| Hadouken | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) |
| qBittorrent | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) |
| rTorrent | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) |
| Torrent Blackhole | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) | ![❌](https://wiki.servarr.com/_assets/svg/twemoji/274c.svg) |
| Transmission | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![Idle Limit](https://img.shields.io/badge/Supported-Idle%20Limit*-blue)\* |
| uTorrent | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) |
| Vuze | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) | ![✅](https://wiki.servarr.com/_assets/svg/twemoji/2705.svg) |
...
## [¶](https://wiki.servarr.com/radarr/settings\#completed-download-handling) Completed Download Handling
...
### [¶](https://wiki.servarr.com/radarr/settings\#remove-completed-downloads) Remove Completed Downloads
...
### [¶](https://wiki.servarr.com/radarr/settings\#failed-download-handling) Failed Download Handling
...
## [¶](https://wiki.servarr.com/radarr/settings\#remote-path-mappings) Remote Path Mappings
...
# [¶](https://wiki.servarr.com/radarr/settings\#import-lists) Import Lists

> Information on supported list types can be found at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#lists) page for this section

## [¶](https://wiki.servarr.com/radarr/settings\#lists) Lists
...
## [¶](https://wiki.servarr.com/radarr/settings\#list-options) List Options
...
## [¶](https://wiki.servarr.com/radarr/settings\#list-exclusions) List Exclusions
...
# [¶](https://wiki.servarr.com/radarr/settings\#connect) Connect

> Information on supported connection types can be found at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#notifications) page for this section

## [¶](https://wiki.servarr.com/radarr/settings\#connections) Connections
...
- A list of supported notifications & connections is located at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#notifications) page


## [¶](https://wiki.servarr.com/radarr/settings\#connection-triggers) Connection Triggers
...
# [¶](https://wiki.servarr.com/radarr/settings\#metadata) Metadata

## [¶](https://wiki.servarr.com/radarr/settings\#options-1) Options

- Certification Country - Select the country to use for Movie Certifications (e.g. R (US) or 12A (UK))

## [¶](https://wiki.servarr.com/radarr/settings\#metadata-consumers) Metadata Consumers

> Information on supported metadata consumers can be found at the [More Info (Supported)](https://wiki.servarr.com/radarr/supported#metadata) page for this section
...
# [¶](https://wiki.servarr.com/radarr/settings\#tags) Tags
...
# [¶](https://wiki.servarr.com/radarr/settings\#general) General

## [¶](https://wiki.servarr.com/radarr/settings\#host) Host
...
## [¶](https://wiki.servarr.com/radarr/settings\#security) Security

- Authentication - How would you like to authenticate to access your Radarr instance
  - As of Radarr v5, Authentication is now mandatory. [See the Mandatory Auth FAQ entry for details.](https://wiki.servarr.com/radarr/faq#forced-authentication)
...
## [¶](https://wiki.servarr.com/radarr/settings\#proxy) Proxy
...
## [¶](https://wiki.servarr.com/radarr/settings\#logging) Logging
...
## [¶](https://wiki.servarr.com/radarr/settings\#analytics) Analytics
...
## [¶](https://wiki.servarr.com/radarr/settings\#updates) Updates

- (Advanced Option) Branch - This is the branch of Radarr that you are running on.
  - [Please see this FAQ entry for more information](https://wiki.servarr.com/radarr/faq#how-do-i-update-radarr)
...
## [¶](https://wiki.servarr.com/radarr/settings\#backups) Backups
...
# [¶](https://wiki.servarr.com/radarr/settings\#ui) UI

## [¶](https://wiki.servarr.com/radarr/settings\#calendar) Calendar
...
## [¶](https://wiki.servarr.com/radarr/settings\#movies) Movies

- Runtime Format - Select how to format runtimes as either hours & minutes or minutes

## [¶](https://wiki.servarr.com/radarr/settings\#dates) Dates
