<!-- Source: https://wiki.servarr.com/sonarr/settings -->

* * *

Sonarr Settings

Documentation of Sonarr Settings Page. Needs work to reflect v4 changes.
...
[sonarr](https://wiki.servarr.com/t/sonarr) [settings](https://wiki.servarr.com/t/settings) [indexers](https://wiki.servarr.com/t/indexers) [configuration](https://wiki.servarr.com/t/configuration) [quality](https://wiki.servarr.com/t/quality) [profiles](https://wiki.servarr.com/t/profiles) [Pages matching tags](https://wiki.servarr.com/t/sonarr/settings/indexers/configuration/quality/profiles)
...
# [¶](https://wiki.servarr.com/sonarr/settings\#table-of-contents) Table of Contents

- [Table of Contents](https://wiki.servarr.com/sonarr/settings#table-of-contents)
- [Menu options](https://wiki.servarr.com/sonarr/settings#menu-options)
- [Media Management](https://wiki.servarr.com/sonarr/settings#media-management)
  - [Community Naming Suggestions](https://wiki.servarr.com/sonarr/settings#community-naming-suggestions)
  - [Episode Naming](https://wiki.servarr.com/sonarr/settings#episode-naming)
    - [Standard Episode Format](https://wiki.servarr.com/sonarr/settings#standard-episode-format)
    - [Series Naming](https://wiki.servarr.com/sonarr/settings#series-naming)
    - [Series IDs](https://wiki.servarr.com/sonarr/settings#series-ids)
    - [Seasons](https://wiki.servarr.com/sonarr/settings#seasons)
    - [Episodes](https://wiki.servarr.com/sonarr/settings#episodes)
    - [Air Date](https://wiki.servarr.com/sonarr/settings#air-date)
    - [Episode Title](https://wiki.servarr.com/sonarr/settings#episode-title)
    - [Quality](https://wiki.servarr.com/sonarr/settings#quality)
    - [Media Info](https://wiki.servarr.com/sonarr/settings#media-info)
    - [Other](https://wiki.servarr.com/sonarr/settings#other)
    - [Original](https://wiki.servarr.com/sonarr/settings#original)
  - [Daily Episode Format](https://wiki.servarr.com/sonarr/settings#daily-episode-format)
  - [Anime Episode Format](https://wiki.servarr.com/sonarr/settings#anime-episode-format)
    - [Absolute Episode Number](https://wiki.servarr.com/sonarr/settings#absolute-episode-number)
  - [Series Folder Format](https://wiki.servarr.com/sonarr/settings#series-folder-format)
    - [Series Naming](https://wiki.servarr.com/sonarr/settings#series-naming-1)
    - [Series IDs](https://wiki.servarr.com/sonarr/settings#series-ids-1)
  - [Season Folder Format](https://wiki.servarr.com/sonarr/settings#season-folder-format)
    - [Seasons](https://wiki.servarr.com/sonarr/settings#seasons-1)
  - [Season Folder Format](https://wiki.servarr.com/sonarr/settings#season-folder-format-1)
    - [Specials](https://wiki.servarr.com/sonarr/settings#specials)
  - [Multi-Episode Style](https://wiki.servarr.com/sonarr/settings#multi-episode-style)
  - [Folders](https://wiki.servarr.com/sonarr/settings#folders)
  - [Importing](https://wiki.servarr.com/sonarr/settings#importing)
  - [File Management](https://wiki.servarr.com/sonarr/settings#file-management)
  - [Permissions](https://wiki.servarr.com/sonarr/settings#permissions)
  - [Root Folders](https://wiki.servarr.com/sonarr/settings#root-folders)
- [Profiles](https://wiki.servarr.com/sonarr/settings#profiles)
  - [Quality Profiles](https://wiki.servarr.com/sonarr/settings#quality-profiles)
  - [Custom Formats](https://wiki.servarr.com/sonarr/settings#custom-formats-1)
  - [Delay Profiles](https://wiki.servarr.com/sonarr/settings#delay-profiles)
    - [Uses](https://wiki.servarr.com/sonarr/settings#uses)
    - [How Delay Profiles Work](https://wiki.servarr.com/sonarr/settings#how-delay-profiles-work)
      - [Examples](https://wiki.servarr.com/sonarr/settings#examples)
        - [Example 1](https://wiki.servarr.com/sonarr/settings#example-1)
        - [Example 2](https://wiki.servarr.com/sonarr/settings#example-2)
        - [Example 3](https://wiki.servarr.com/sonarr/settings#example-3)
- [Quality](https://wiki.servarr.com/sonarr/settings#quality-1)
  - [Quality Table Meanings](https://wiki.servarr.com/sonarr/settings#quality-table-meanings)
  - [Qualities Defined](https://wiki.servarr.com/sonarr/settings#qualities-defined)
- [Indexers](https://wiki.servarr.com/sonarr/settings#indexers)
  - [Supported Indexers](https://wiki.servarr.com/sonarr/settings#supported-indexers)
    - [Indexer Settings](https://wiki.servarr.com/sonarr/settings#indexer-settings)
    - [Usenet Indexer Configuration](https://wiki.servarr.com/sonarr/settings#usenet-indexer-configuration)
    - [Torrent Tracker Configuration](https://wiki.servarr.com/sonarr/settings#torrent-tracker-configuration)
  - [Options](https://wiki.servarr.com/sonarr/settings#options)
- [Download Clients](https://wiki.servarr.com/sonarr/settings#download-clients)
  - [Overview](https://wiki.servarr.com/sonarr/settings#overview)
  - [Download Client Processes](https://wiki.servarr.com/sonarr/settings#download-client-processes)
  - [Usenet](https://wiki.servarr.com/sonarr/settings#usenet)
  - [BitTorrent](https://wiki.servarr.com/sonarr/settings#bittorrent)
  - [Download Clients](https://wiki.servarr.com/sonarr/settings#download-clients-1)
    - [Supported Download Clients](https://wiki.servarr.com/sonarr/settings#supported-download-clients)
    - [Usenet Client Settings](https://wiki.servarr.com/sonarr/settings#usenet-client-settings)
    - [Torrent Client Settings](https://wiki.servarr.com/sonarr/settings#torrent-client-settings)
    - [Torrent Client Remove Download Compatibility](https://wiki.servarr.com/sonarr/settings#torrent-client-remove-download-compatibility)
  - [Completed Download Handling](https://wiki.servarr.com/sonarr/settings#completed-download-handling)
    - [Remove Completed Downloads](https://wiki.servarr.com/sonarr/settings#remove-completed-downloads)
    - [Failed Download Handling](https://wiki.servarr.com/sonarr/settings#failed-download-handling)
  - [Remote Path Mappings](https://wiki.servarr.com/sonarr/settings#remote-path-mappings)
- [Import Lists](https://wiki.servarr.com/sonarr/settings#import-lists)
  - [Lists](https://wiki.servarr.com/sonarr/settings#lists)
  - [List Exclusions](https://wiki.servarr.com/sonarr/settings#list-exclusions)
- [Connect](https://wiki.servarr.com/sonarr/settings#connect)
  - [Connections](https://wiki.servarr.com/sonarr/settings#connections)
  - [Connection Triggers](https://wiki.servarr.com/sonarr/settings#connection-triggers)
- [Metadata](https://wiki.servarr.com/sonarr/settings#metadata)
  - [Metadata](https://wiki.servarr.com/sonarr/settings#metadata-1)
- [Tags](https://wiki.servarr.com/sonarr/settings#tags)
- [General](https://wiki.servarr.com/sonarr/settings#general)
  - [Host](https://wiki.servarr.com/sonarr/settings#host)
  - [Security](https://wiki.servarr.com/sonarr/settings#security)
  - [Proxy](https://wiki.servarr.com/sonarr/settings#proxy)
  - [Logging](https://wiki.servarr.com/sonarr/settings#logging)
  - [Analytics](https://wiki.servarr.com/sonarr/settings#analytics)
  - [Updates](https://wiki.servarr.com/sonarr/settings#updates)
  - [Backups](https://wiki.servarr.com/sonarr/settings#backups)
- [UI](https://wiki.servarr.com/sonarr/settings#ui)
  - [Calendar](https://wiki.servarr.com/sonarr/settings#calendar)
  - [Dates](https://wiki.servarr.com/sonarr/settings#dates)
  - [Style](https://wiki.servarr.com/sonarr/settings#style)

This page will go through all the settings available in Sonarr and how they work. This is not meant to be a comprehensive "How to set up Sonarr." Refer to the [Quick Start](https://wiki.servarr.com/sonarr/quick-start-guide) page instead.

# [¶](https://wiki.servarr.com/sonarr/settings\#menu-options) Menu options

To get to the Settings page, please choose Settings from the left menu. The following sub-menu options will be available:

![settings_1_menu.png](https://wiki.servarr.com/assets/sonarr/settings_1_menu.png)

Also, note that for each individual settings page, there are some options at the top of the menu:

![settings_2_topmenu.png](https://wiki.servarr.com/assets/sonarr/settings_2_topmenu.png)
...
# [¶](https://wiki.servarr.com/sonarr/settings\#media-management) Media Management

> Some of these settings are only visible through `Show Advanced Settings` which is on the top bar under the search bar

## [¶](https://wiki.servarr.com/sonarr/settings\#community-naming-suggestions) Community Naming Suggestions
...
## [¶](https://wiki.servarr.com/sonarr/settings\#episode-naming) Episode Naming
...
### [¶](https://wiki.servarr.com/sonarr/settings\#standard-episode-format) Standard Episode Format
...
### [¶](https://wiki.servarr.com/sonarr/settings\#series-naming) Series Naming
...
### [¶](https://wiki.servarr.com/sonarr/settings\#series-ids) Series IDs

- `{ImdbId}` = tt12345
- `{Tmdbid}` = 123456
- `{TvMazeId}`= 54321

### [¶](https://wiki.servarr.com/sonarr/settings\#seasons) Seasons

- `{season:0}` = 1
- `{season:00}` = 01

### [¶](https://wiki.servarr.com/sonarr/settings\#episodes) Episodes

- `{episode:0}` = 1
- `{episode:00}` = 01

### [¶](https://wiki.servarr.com/sonarr/settings\#air-date) Air Date

- `{Air-Date}` = 2020-09-03
- `{Air Date}` = 2020 09 03

### [¶](https://wiki.servarr.com/sonarr/settings\#episode-title) Episode Title

- `{Episode Title}` = Episode Title
- `{Episode CleanTitle}` = Episode Title

### [¶](https://wiki.servarr.com/sonarr/settings\#quality) Quality

- `{Quality Full}` = HDTV 720p Proper
- `{Quality Title}` = HDTV 720p

### [¶](https://wiki.servarr.com/sonarr/settings\#media-info) Media Info
...
### [¶](https://wiki.servarr.com/sonarr/settings\#other) Other
...
### [¶](https://wiki.servarr.com/sonarr/settings\#original) Original
...
## [¶](https://wiki.servarr.com/sonarr/settings\#daily-episode-format) Daily Episode Format
...
See [Standard Episode Format](https://wiki.servarr.com/sonarr/settings#standard-episode-format) for more info about this dialog box.

## [¶](https://wiki.servarr.com/sonarr/settings\#anime-episode-format) Anime Episode Format
...
### [¶](https://wiki.servarr.com/sonarr/settings\#absolute-episode-number) Absolute Episode Number

- `{absolute:0}` = 1
- `{absolute:00}` = 01
- `{absolute:000}` =001

## [¶](https://wiki.servarr.com/sonarr/settings\#series-folder-format) Series Folder Format
...
### [¶](https://wiki.servarr.com/sonarr/settings\#series-naming-1) Series Naming
...
### [¶](https://wiki.servarr.com/sonarr/settings\#series-ids-1) Series IDs

- `{ImdbId}` = tt12345
- `{Tmdbid}` = 123456
- `{TvMazeId}` = 54321

## [¶](https://wiki.servarr.com/sonarr/settings\#season-folder-format) Season Folder Format

### [¶](https://wiki.servarr.com/sonarr/settings\#seasons-1) Seasons

- `{season:0}` = 1
- `{season:00}` = 01

## [¶](https://wiki.servarr.com/sonarr/settings\#season-folder-format-1) Season Folder Format

### [¶](https://wiki.servarr.com/sonarr/settings\#specials) Specials
...
## [¶](https://wiki.servarr.com/sonarr/settings\#multi-episode-style) Multi-Episode Style
...
## [¶](https://wiki.servarr.com/sonarr/settings\#folders) Folders
...
## [¶](https://wiki.servarr.com/sonarr/settings\#importing) Importing
...
## [¶](https://wiki.servarr.com/sonarr/settings\#file-management) File Management
...
## [¶](https://wiki.servarr.com/sonarr/settings\#permissions) Permissions
...
## [¶](https://wiki.servarr.com/sonarr/settings\#root-folders) Root Folders
...
# [¶](https://wiki.servarr.com/sonarr/settings\#profiles) Profiles

## [¶](https://wiki.servarr.com/sonarr/settings\#quality-profiles) Quality Profiles
...
- Edit Groups - Some qualities are grouped together to reduce the size of the list as well grouping like releases. Prime example of this is `WebDL` and `WebRip` as these are very similar and typically have similar bitrates. When editing the groups you can change the preference within each of the groups. [See TRaSh's Guide for how to Merge Qualities](https://trash-guides.info/merge-quality)
  - [See Qualities](https://wiki.servarr.com/sonarr/settings#qualities-defined)

> By default the qualities are set from lowest (bottom) to highest (top)

# [¶](https://wiki.servarr.com/sonarr/settings\#custom-formats) Custom Formats
...
## [¶](https://wiki.servarr.com/sonarr/settings\#custom-format-conditions) Custom Format Conditions

### [¶](https://wiki.servarr.com/sonarr/settings\#modifiers) Modifiers
...
### [¶](https://wiki.servarr.com/sonarr/settings\#conditions) Conditions
...
### [¶](https://wiki.servarr.com/sonarr/settings\#profiling-settings-and-ranking) Profiling Settings and Ranking
...
#### [¶](https://wiki.servarr.com/sonarr/settings\#importing-exporting-custom-formats) Importing / Exporting Custom Formats
...
#### [¶](https://wiki.servarr.com/sonarr/settings\#importing-updating-existing-custom-formats) Importing / Updating Existing Custom Formats
...
### [¶](https://wiki.servarr.com/sonarr/settings\#collection-of-custom-formats) Collection of Custom Formats

- [TRaSH maintains a collection of custom formats](https://trash-guides.info/Sonarr/sonarr-collection-of-custom-formats/)

## [¶](https://wiki.servarr.com/sonarr/settings\#delay-profiles) Delay Profiles
...
### [¶](https://wiki.servarr.com/sonarr/settings\#uses) Uses
...
Delay profiles are also helpful if you want to emphasize one protocol (Usenet or BitTorrent) over the other. (See [Example 3](https://wiki.servarr.com/sonarr/settings/#example-3))

### [¶](https://wiki.servarr.com/sonarr/settings\#how-delay-profiles-work) How Delay Profiles Work
...
#### [¶](https://wiki.servarr.com/sonarr/settings\#examples) Examples
...
##### [¶](https://wiki.servarr.com/sonarr/settings\#example-1) Example 1
...
##### [¶](https://wiki.servarr.com/sonarr/settings\#example-2) Example 2
...
##### [¶](https://wiki.servarr.com/sonarr/settings\#example-3) Example 3
...
## [¶](https://wiki.servarr.com/sonarr/settings\#release-profiles) Release Profiles
...
# [¶](https://wiki.servarr.com/sonarr/settings\#quality-1) Quality

## [¶](https://wiki.servarr.com/sonarr/settings\#quality-table-meanings) Quality Table Meanings
...
## [¶](https://wiki.servarr.com/sonarr/settings\#qualities-defined) Qualities Defined
...
# [¶](https://wiki.servarr.com/sonarr/settings\#indexers) Indexers

> Information on supported indexers can be found at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#indexers) page for this section

## [¶](https://wiki.servarr.com/sonarr/settings\#supported-indexers) Supported Indexers

- A list of supported indexers is located at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#indexers) page

### [¶](https://wiki.servarr.com/sonarr/settings\#indexer-settings) Indexer Settings
...
### [¶](https://wiki.servarr.com/sonarr/settings\#usenet-indexer-configuration) Usenet Indexer Configuration
...
- Software that works with usenet and integrates quite well with Sonarr are [NZBHydra2](https://github.com/theotherp/nzbhydra2/) or [Prowlarr](https://wiki.servarr.com/prowlarr) which integrate with both Usenet and Torrents
...
- Anime Standard Format Search - Also search for anime using the standard numbering (Only Applies for Anime Series Types) [More Information on Series Types here](https://wiki.servarr.com/sonarr/faq#whats-the-different-series-types)
...
### [¶](https://wiki.servarr.com/sonarr/settings\#torrent-tracker-configuration) Torrent Tracker Configuration
...
- One of the best and simplest ways to utilize Torrent trackers that are not natively supported with Sonarr is to utilize a second program such as [Prowlarr](https://wiki.servarr.com/prowlarr) or [Jackett](https://github.com/Jackett/Jackett). These software pair well with Sonarr as a search indexer that houses all your information and sends it to Sonarr.
...
## [¶](https://wiki.servarr.com/sonarr/settings\#options) Options
...
- RSS Sync interval - Interval in minutes. Set to zero to disable (this will stop all automatic release grabbing) Minimum: 10 minutes Maximum: 120 minutes
  - Please see [How does Sonarr find episodes?](https://wiki.servarr.com/sonarr/faq#how-does-sonarr-find-episodes) for a better understanding of how RSS Sync will help you
...
# [¶](https://wiki.servarr.com/sonarr/settings\#download-clients) Download Clients

> Information on supported download clients can be found at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#download-clients) page for this section

## [¶](https://wiki.servarr.com/sonarr/settings\#overview) Overview

- Downloading and importing is where most people experience issues. From a high level perspective, the software needs to be able to communicate with your download client and have access to the files it downloads. There is a large variety of supported download clients and an even bigger variety of setups. This means that while there are some common setups there isn't one right setup and everyone's setup can be a little different. But there are many wrong setups.

## [¶](https://wiki.servarr.com/sonarr/settings\#download-client-processes) Download Client Processes

## [¶](https://wiki.servarr.com/sonarr/settings\#usenet) Usenet
...
## [¶](https://wiki.servarr.com/sonarr/settings\#bittorrent) BitTorrent
...
## [¶](https://wiki.servarr.com/sonarr/settings\#download-clients-1) Download Clients
...
### [¶](https://wiki.servarr.com/sonarr/settings\#supported-download-clients) Supported Download Clients

- A list of supported download clients is located at the [More Info Supported](https://wiki.servarr.com/sonarr/supported#download-clients) page

Select the download client you wish to add, and there will be a pop-up box to enter connection details. These details are similar for most clients. Some will ask for a username or password, some will ask for whether to add new downloads in a paused/start state, etc.

### [¶](https://wiki.servarr.com/sonarr/settings\#usenet-client-settings) Usenet Client Settings
...
- Completed Download Handling
  - Remove (Per Client Setting) - Remove completed downloads when finished (usenet) or stopped/complete (torrents). See [Completed Download Handling for more details](https://wiki.servarr.com/sonarr/settings#completed-download-handling)

### [¶](https://wiki.servarr.com/sonarr/settings\#torrent-client-settings) Torrent Client Settings
...
### [¶](https://wiki.servarr.com/sonarr/settings\#torrent-client-remove-download-compatibility) Torrent Client Remove Download Compatibility
...
## [¶](https://wiki.servarr.com/sonarr/settings\#completed-download-handling) Completed Download Handling
...
### [¶](https://wiki.servarr.com/sonarr/settings\#remove-completed-downloads) Remove Completed Downloads
...
### [¶](https://wiki.servarr.com/sonarr/settings\#failed-download-handling) Failed Download Handling
...
## [¶](https://wiki.servarr.com/sonarr/settings\#remote-path-mappings) Remote Path Mappings
...
# [¶](https://wiki.servarr.com/sonarr/settings\#import-lists) Import Lists

> Information on supported list types can be found at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#lists) page for this section

## [¶](https://wiki.servarr.com/sonarr/settings\#lists) Lists
...
### [¶](https://wiki.servarr.com/sonarr/settings\#list-options) List Options
...
## [¶](https://wiki.servarr.com/sonarr/settings\#list-exclusions) List Exclusions
...
# [¶](https://wiki.servarr.com/sonarr/settings\#connect) Connect

> Information on supported connection types can be found at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#notifications) page for this section

## [¶](https://wiki.servarr.com/sonarr/settings\#connections) Connections
...
- A list of supported notifications & connections is located at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#notifications)


## [¶](https://wiki.servarr.com/sonarr/settings\#connection-triggers) Connection Triggers
...
# [¶](https://wiki.servarr.com/sonarr/settings\#metadata) Metadata

## [¶](https://wiki.servarr.com/sonarr/settings\#metadata-1) Metadata

> Information on supported metadata consumers can be found at the [More Info (Supported)](https://wiki.servarr.com/sonarr/supported#metadata) page for this section
...
# [¶](https://wiki.servarr.com/sonarr/settings\#tags) Tags
...
# [¶](https://wiki.servarr.com/sonarr/settings\#general) General

## [¶](https://wiki.servarr.com/sonarr/settings\#host) Host
...
> Note: If using a reverse proxy (example: [mydomain.com/sonarr](http://mydomain.com/sonarr)) you would enter '/sonarr' for URL Base.
...
## [¶](https://wiki.servarr.com/sonarr/settings\#security) Security
...
## [¶](https://wiki.servarr.com/sonarr/settings\#proxy) Proxy
...
## [¶](https://wiki.servarr.com/sonarr/settings\#logging) Logging
...
## [¶](https://wiki.servarr.com/sonarr/settings\#analytics) Analytics
...
## [¶](https://wiki.servarr.com/sonarr/settings\#updates) Updates

- (Advanced Option) Branch - This is the branch of Sonarr that you are running on.
  - [Please see this FAQ entry for more information](https://wiki.servarr.com/sonarr/faq#how-do-i-update-sonarr)
...
## [¶](https://wiki.servarr.com/sonarr/settings\#backups) Backups
...
# [¶](https://wiki.servarr.com/sonarr/settings\#ui) UI

## [¶](https://wiki.servarr.com/sonarr/settings\#calendar) Calendar
...
## [¶](https://wiki.servarr.com/sonarr/settings\#dates) Dates
...
## [¶](https://wiki.servarr.com/sonarr/settings\#style) Style
