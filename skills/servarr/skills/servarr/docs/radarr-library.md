...
- Once you've added a movie by one of the three options listed above, you will be presented with different movies to discover.
  ...
  8.  Do you want Radarr to exclude these movies from any lists that would be imported? (<a href="/radarr/settings#list-exclusions" class="is-internal-link is-valid-page">More info</a>)
