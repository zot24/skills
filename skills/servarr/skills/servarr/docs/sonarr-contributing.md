> Source: https://wiki.servarr.com/sonarr/contributing
...
Setup guides, <a href="/sonarr/faq" class="is-internal-link is-valid-page">FAQ</a>, the more information we have on the <a href="/sonarr" class="is-internal-link is-valid-page">wiki</a> the better.
...
> For css changes `yarn stylelint --fix`
...
2.  Next `Debug/Run` the project in Visual Studio to start Sonarr
3.  Open <a href="http://localhost:8989" class="is-external-link">http://localhost:8989</a>
...
- If you're adding a new, already requested feature, please comment on <a href="https://github.com/Sonarr/Sonarr/issues" class="is-external-link">GitHub Issues</a> so work is not duplicated (If you want to add something not already on there, please talk to us first)
...
Sonarr uses a self hosted open access <a href="https://translate.servarr.com" class="is-external-link">Weblate</a> instance to manage its json translation files. These files are stored in the repo at `src/NzbDrone.Core/Localization`
