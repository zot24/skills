> Source: https://wiki.servarr.com/prowlarr/quick-start-guide
...
> For a more detailed breakdown of all the settings, check <a href="/prowlarr/settings" class="is-internal-link is-valid-page">Prowlarr =&gt;Settings</a>
...
# <a href="#apps" class="toc-anchor">¶</a> Apps
...
> Currently supported Apps can be found at the <a href="/prowlarr/supported#applications" class="is-internal-link is-valid-page">More Info (Supported)</a> page for this section
...
> Currently supported Download Clients can be found at the <a href="/prowlarr/supported#downloadclient" class="is-internal-link is-valid-page">More Info (Supported)</a> page for this section
...
# <a href="#setup-complete" class="toc-anchor">¶</a> Setup Complete
