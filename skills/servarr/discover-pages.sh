...
if [ "$AUTO_ADD" = "true" ]; then
    ...
    echo "  .github/workflows/scripts/sync-skill.sh skills/servarr --force"
else
    echo ""
    echo "To auto-add these to sync.json, run:"
    echo "  ./skills/servarr/discover-pages.sh --auto-add"
    echo ""
    echo "Alternatively, use Firecrawl for better content extraction:"
    echo "  firecrawl crawl $BASE_URL --output skills/servarr/docs/"
fi
