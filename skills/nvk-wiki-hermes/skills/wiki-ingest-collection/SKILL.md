---
name: wiki-ingest-collection
description: >-
  Bulk-ingest source collections such as Git doc repos, MediaWiki sources, CSV/JSON message archives, and Wayback CDX snapshots into raw sources. Use when the user runs /wiki-ingest-collection or /wiki:ingest-collection. Official nvk/llm-wiki v0.23.0 command body. Never use bundled Karpathy llm-wiki against this hub.
...
# wiki-ingest-collection — nvk v0.23.0 `/wiki:ingest-collection`

Vendored **verbatim** from nvk/llm-wiki **v0.23.0** (`d02cbcb`)
`claude-plugin/commands/ingest-collection.md`.
Do **not** invent compile, ingest, lint, or query protocols.

- Hermes slash: `/wiki-ingest-collection` (hyphen). Claude: `/wiki:ingest-collection` (colon). Hermes cannot use colons in slashes.
...
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/ingestion.md` (in-skill copy: `references/ingestion.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/ingestion.md)
...
Official command body follows. `$ARGUMENTS` is the text after `/wiki-ingest-collection`.
...
Read `references/ingestion.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/ingestion.md`) and `references/wiki-structure.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/wiki-structure.md`), then follow the collection ingestion protocol.
