...
name: wiki-collect
description: >-
  Find, catalog, deduplicate, and optionally inventory bounded sets of artifacts, examples, resources, memes, tools, entities, media, or other collectible things. Use when the user runs /wiki-collect or /wiki:collect. Official nvk/llm-wiki v0.23.0 command body. Never use bundled Karpathy llm-wiki against this hub.
...
# wiki-collect — nvk v0.23.0 `/wiki:collect`

Vendored **verbatim** from nvk/llm-wiki **v0.23.0** (`d02cbcb`)
`claude-plugin/commands/collect.md`.
Do **not** invent compile, ingest, lint, or query protocols.

- Hermes slash: `/wiki-collect` (hyphen). Claude: `/wiki:collect` (colon). Hermes cannot use colons in slashes.
...
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/inventory.md` (in-skill copy: `references/inventory.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/inventory.md)
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/research-infrastructure.md` (in-skill copy: `references/research-infrastructure.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/research-infrastructure.md)

Official command body follows. `$ARGUMENTS` is the text after `/wiki-collect`.
...
Read `references/inventory.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/inventory.md`) and
`references/research-infrastructure.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/research-infrastructure.md`) before writing. Use
