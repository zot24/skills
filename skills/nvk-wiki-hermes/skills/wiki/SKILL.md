...
name: wiki
description: >-
  LLM wiki knowledge base — understands natural language. Say what you want (use a private specialist method, edit an external resource through a registered adapter, capture or shape an Idea, add a URL, collect a catalog, track inventory, ask a question, research, audit, or resume work) and it routes to the right workflow. Also handles init, status, and config. Use when the user runs /wiki or /wiki. Official nvk/llm-wiki v0.23.0 command body. Never use bundled Karpathy llm-wiki against this hub.
allowed-tools: Read, Write, Edit, Glob, Bash(ls:*), Bash(wc:*), Bash(mkdir:*), Bash(date:*), Bash(mv:*)
---

# wiki — nvk v0.23.0 `/wiki`
...
- Hermes slash: `/wiki` (hyphen). Claude: `/wiki` (colon). Hermes cannot use colons in slashes.
...
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/wiki-structure.md` (in-skill copy: `references/wiki-structure.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/wiki-structure.md)
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/projects.md` (in-skill copy: `references/projects.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/projects.md)
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/SKILL.md` (in-skill copy: `references/wiki-manager-SKILL.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/SKILL.md)

Official command body follows. `$ARGUMENTS` is the text after `/wiki`.
...
You are the llm-wiki knowledge base manager. Read the skill at `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/SKILL.md` (also vendored at `references/wiki-manager-SKILL.md`) and structure reference at `references/wiki-structure.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/wiki-structure.md`) for full conventions.
...
- **No ambient project focus**: `--project <slug>` must be passed explicitly by the user. The focus-session mechanism was removed in the v0.2 projects simplification (see `references/projects.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/projects.md`) § "Focus"). If the user says "work on project X" without a clear sub-intent, treat it as a request to `show` the project — not as a focus state change.
