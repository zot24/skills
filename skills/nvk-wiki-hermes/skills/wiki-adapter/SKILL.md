...
`claude-plugin/commands/adapter.md`.
Do **not** invent compile, ingest, lint, or query protocols.

- Hermes slash: `/wiki-adapter` (hyphen). Claude: `/wiki:adapter` (colon). Hermes cannot use colons in slashes.
...
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/adapters.md` (in-skill copy: `references/adapters.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/adapters.md)
...
CLI. Read `references/adapters.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/adapters.md`) before acting.
