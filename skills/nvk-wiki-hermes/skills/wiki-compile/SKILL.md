...
name: wiki-compile
description: >-
  Compile raw sources into wiki articles. Synthesizes, cross-references, and organizes active knowledge. Use when the user runs /wiki-compile or /wiki:compile. Official nvk/llm-wiki v0.23.0 command body. Never use bundled Karpathy llm-wiki against this hub.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash(ls:*), Bash(wc:*), Bash(date:*), Bash(mv:*), Bash(mkdir:*)
---

# wiki-compile — nvk v0.23.0 `/wiki:compile`

Vendored **verbatim** from nvk/llm-wiki **v0.23.0** (`d02cbcb`)
`claude-plugin/commands/compile.md`.
Do **not** invent compile, ingest, lint, or query protocols.

- Hermes slash: `/wiki-compile` (hyphen). Claude: `/wiki:compile` (colon). Hermes cannot use colons in slashes.
...
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/indexing.md` (in-skill copy: `references/indexing.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/indexing.md)

Official command body follows. `$ARGUMENTS` is the text after `/wiki-compile`.
...
Read the compilation protocol at `references/compilation.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/compilation.md`) and the indexing protocol at `references/indexing.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/indexing.md`). Then compile raw sources into wiki articles.
