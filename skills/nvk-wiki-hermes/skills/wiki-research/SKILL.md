...
name: wiki-research
description: >-
  Deep multi-agent research on a topic, question, or thesis. Launches parallel agents to search the web, ingests sources, and compiles them into active wiki articles. Thesis mode provides for/against evidence framing with a verdict. Use when the user runs /wiki-research or /wiki:research. Official nvk/llm-wiki v0.23.0 command body. Never use bundled Karpathy llm-wiki against this hub.
...
# wiki-research — nvk v0.23.0 `/wiki:research`
...
- Hermes slash: `/wiki-research` (hyphen). Claude: `/wiki:research` (colon). Hermes cannot use colons in slashes.
...
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/specialists.md` (in-skill copy: `references/specialists.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/specialists.md)
- `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/compilation.md` (in-skill copy: `references/compilation.md`; tag: https://raw.githubusercontent.com/nvk/llm-wiki/v0.23.0/plugins/llm-wiki-opencode/skills/wiki-manager/references/compilation.md)

Official command body follows. `$ARGUMENTS` is the text after `/wiki-research`.
...
`references/specialists.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/specialists.md`). If `--no-specialists` is set,
...
2. Follow the compilation protocol in `references/compilation.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/compilation.md`):
