...
`claude-plugin/commands/specialist.md`.
Do **not** invent compile, ingest, lint, or query protocols.

- Hermes slash: `/wiki-specialist` (hyphen). Claude: `/wiki:specialist` (colon). Hermes cannot use colons in slashes.
...
`references/specialists.md` (vendored v0.23.0; pin `~/.claude/plugins/marketplaces/llm-wiki/plugins/llm-wiki-opencode/skills/wiki-manager/references/specialists.md`) before acting. A specialist is
