...
- Hermes slash: `/wiki-plan` (hyphen). Claude: `/wiki:plan` (colon). Hermes cannot use colons in slashes.
...
Official command body follows. `$ARGUMENTS` is the text after `/wiki-plan`.
