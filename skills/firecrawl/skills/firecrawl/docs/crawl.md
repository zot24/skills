...
| `allowExternalLinks`    | `boolean`  | `false`     | Follow links to external websites. External links are followed one hop (their own links are not crawled), and links pointing to an external site’s homepage are skipped — see <a href="#external-links" class="link">External links</a>.                                                                                                                             |
