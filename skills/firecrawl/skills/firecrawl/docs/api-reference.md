...
<a href="/introduction" class="link nav-tabs-item group relative h-full gap-2 flex items-center font-medium hover:text-gray-800 dark:hover:text-gray-300 text-gray-800 dark:text-gray-200">Documentation</a>
...
<a href="/api-reference/v2-introduction" class="link nav-tabs-item group relative h-full gap-2 flex items-center font-medium [text-shadow:-0.2px_0_0_currentColor,0.2px_0_0_currentColor] hover:text-primary dark:hover:text-primary-light text-gray-800 dark:text-gray-200" data-active="true">API Reference</a>
...
- <span id="/api-reference/endpoint/search"><a href="/api-reference/endpoint/search" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
...
- <span id="/api-reference/endpoint/scrape"><a href="/api-reference/endpoint/scrape" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/batch-scrape"><a href="/api-reference/endpoint/batch-scrape" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/batch-scrape-get"><a href="/api-reference/endpoint/batch-scrape-get" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Get Batch Scrape Status</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/batch-scrape-delete"><a href="/api-reference/endpoint/batch-scrape-delete" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Cancel Batch Scrape</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/batch-scrape-get-errors"><a href="/api-reference/endpoint/batch-scrape-get-errors" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Get Batch Scrape Errors</span>
...
- <span id="/api-reference/endpoint/scrape-execute"><a href="/api-reference/endpoint/scrape-execute" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Interact with the page</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/scrape-browser-delete"><a href="/api-reference/endpoint/scrape-browser-delete" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Stop Interacting</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/browser-list"><a href="/api-reference/endpoint/browser-list" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">List Browser Sessions</span>
...
- <span id="/api-reference/endpoint/map"><a href="/api-reference/endpoint/map" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/parse"><a href="/api-reference/endpoint/parse" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/crawl-post"><a href="/api-reference/endpoint/crawl-post" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/crawl-get"><a href="/api-reference/endpoint/crawl-get" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Get Crawl Status</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/crawl-params-preview"><a href="/api-reference/endpoint/crawl-params-preview" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Crawl Params Preview</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/crawl-delete"><a href="/api-reference/endpoint/crawl-delete" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Cancel Crawl</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/crawl-get-errors"><a href="/api-reference/endpoint/crawl-get-errors" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/crawl-active"><a href="/api-reference/endpoint/crawl-active" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Get Active Crawls</span>
...
- <span id="/api-reference/endpoint/activity"><a href="/api-reference/endpoint/activity" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Activity</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/credit-usage"><a href="/api-reference/endpoint/credit-usage" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
...
- <span id="/api-reference/endpoint/credit-usage-historical"><a href="/api-reference/endpoint/credit-usage-historical" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Historical Credit Usage</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/token-usage"><a href="/api-reference/endpoint/token-usage" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Token Usage</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/token-usage-historical"><a href="/api-reference/endpoint/token-usage-historical" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Historical Token Usage</span>

  </div>

  </div>
- <span id="/api-reference/endpoint/queue-status"><a href="/api-reference/endpoint/queue-status" class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" style="padding-left:1rem"></a></span>
  <div class="h-[1lh] flex items-center shrink-0">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Queue Status</span>
...
- <a href="#features" class="break-words py-1 block border-l pl-4 border-gray-950/5 dark:border-white/10 hover:border-gray-950/20 dark:hover:border-white/20 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Features</a>
- <a href="#agentic-features" class="break-words py-1 block border-l pl-4 border-gray-950/5 dark:border-white/10 hover:border-gray-950/20 dark:hover:border-white/20 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Agentic Features</a>
