<!-- Source: https://wiki.servarr.com/sonarr/wanted -->

* * *

Sonarr Wanted

Managing wanted episodes, manual searches, and download monitoring in Sonarr's Wanted section
...
[sonarr](https://wiki.servarr.com/t/sonarr) [wanted](https://wiki.servarr.com/t/wanted) [monitoring](https://wiki.servarr.com/t/monitoring) [search](https://wiki.servarr.com/t/search) [episodes](https://wiki.servarr.com/t/episodes) [missing](https://wiki.servarr.com/t/missing) [Pages matching tags](https://wiki.servarr.com/t/sonarr/wanted/monitoring/search/episodes/missing)
...
# [¶](https://wiki.servarr.com/sonarr/wanted\#wanted) Wanted
...
# [¶](https://wiki.servarr.com/sonarr/wanted\#cutoff-unmet) Cutoff Unmet
...
![wanted-cut-off-unmet.png](https://wiki.servarr.com/assets/sonarr/wanted-cut-off-unmet.png)
