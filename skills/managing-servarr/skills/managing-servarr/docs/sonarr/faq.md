...
Sonarr Frequently Asked Questions
...
> For Sonarr v4 specific FAQ entries - Please see the [Sonarr v4 FAQ](https://wiki.servarr.com/sonarr/faq-v4)

# [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-basics) Sonarr Basics

## [¶](https://wiki.servarr.com/sonarr/faq\#how-does-sonarr-find-episodes) How does Sonarr find episodes
...
- If you've already added the show, but now you want to search for it, you have a few choices. You can go to the show's page and use the search button, which will do a search and then automatically pick episode(s). You can search individual episodes or seasons automatically or manually. Or you can go to the [Wanted](https://wiki.servarr.com/sonarr/wanted) tab and search from there.
...
### [¶](https://wiki.servarr.com/sonarr/faq\#instances-when-auto-searching-does-occur) Instances When Auto Searching Does Occur
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-are-possible-downloads-compared) How are possible downloads compared
...
> REPACKS and PROPERs are v2 of Qualities and thus rank above a non-repack of the same quality. [Set Media Management => File Management `Download Proper & Repacks` to "Do Not Prefer"](https://wiki.servarr.com/sonarr/settings#file-management) and use [TRaSH's Repack/Proper Custom Format](https://trash-guides.info/Sonarr/sonarr-collection-of-custom-formats/#repackproper) with a positive score as suggested by [TRaSH's Guides](https://trash-guides.info/Sonarr/sonarr-setup-quality-profiles/)
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-do-i-change-from-the-windows-service-to-a-tray-app) How do I change from the Windows Service to a Tray App
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-do-i-backuprestore-my-sonarr) How do I Backup/Restore my Sonarr

### [¶](https://wiki.servarr.com/sonarr/faq\#backing-up-sonarr) Backing up Sonarr

#### [¶](https://wiki.servarr.com/sonarr/faq\#using-built-in-backup) Using built-in backup

- Go to System => Backup in the Sonarr UI
- Click the Backup button
- Download the zip after the backup is created for safekeeping

#### [¶](https://wiki.servarr.com/sonarr/faq\#using-file-system-directly) Using file system directly

- Find the location of the AppData directory for Sonarr
  - Via the Sonarr UI go to System => About
  - [Sonarr Appdata Directory](https://wiki.servarr.com/sonarr/appdata-directory)
- Stop Sonarr - This will prevent the database from being corrupted
- Copy the contents to a safe location

### [¶](https://wiki.servarr.com/sonarr/faq\#restoring-from-backup) Restoring from Backup
...
#### [¶](https://wiki.servarr.com/sonarr/faq\#using-zip-backup) Using zip backup
...
#### [¶](https://wiki.servarr.com/sonarr/faq\#using-file-system-backup) Using file system backup
...
#### [¶](https://wiki.servarr.com/sonarr/faq\#file-system-restore-on-synology-nas) File System Restore on Synology NAS
...
## [¶](https://wiki.servarr.com/sonarr/faq\#help-i-have-locked-myself-out) Help I have locked myself out

> Authentication is now mandatory in v4 of Sonarr and the `AuthenticationMethod` type `None` is no longer valid - please see this [v4 FAQ - Forced Authentication](https://wiki.servarr.com/sonarr/faq-v4#forced-authentication)

To disable authentication (to reset your forgotten username or password) you will need need to edit `config.xml` which will be inside the [Sonarr Appdata Directory](https://wiki.servarr.com/sonarr/appdata-directory)
...
_**(Be sure that you do not have two AuthenticationMethod entries in your file)**_
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-are-there-two-files-why-is-there-a-file-left-in-downloads) Why are there two files? \| Why is there a file left in downloads
...
## [¶](https://wiki.servarr.com/sonarr/faq\#i-see-that-featurebug-x-was-fixed-why-can-i-not-see-it) I see that feature/bug X was fixed, Why can I not see it
...
## [¶](https://wiki.servarr.com/sonarr/faq\#episode-progress-how-is-it-calculated) Episode Progress - How is it calculated
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-do-i-access-sonarr-from-another-computer) How do I access Sonarr from another computer
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-does-sonarr-refresh-series-information-so-frequently) Why does Sonarr refresh series information so frequently
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-is-there-a-number-next-to-activity) Why is there a number next to Activity
...
## [¶](https://wiki.servarr.com/sonarr/faq\#whats-the-different-series-types) What's the different Series Types
...
#### [¶](https://wiki.servarr.com/sonarr/faq\#standard) Standard
...
#### [¶](https://wiki.servarr.com/sonarr/faq\#anime) Anime
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-can-i-rename-my-series-folders) How can I rename my series folders
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-do-i-update-sonarr) How do I update Sonarr
...
### [¶](https://wiki.servarr.com/sonarr/faq\#installing-a-newer-version) Installing a newer version

#### [¶](https://wiki.servarr.com/sonarr/faq\#native) Native
...
#### [¶](https://wiki.servarr.com/sonarr/faq\#docker) Docker

1. Repull your tag and update your container

## [¶](https://wiki.servarr.com/sonarr/faq\#can-i-switch-from-develop-back-to-main) Can I switch from `develop` back to `main`

- See the entry below

## [¶](https://wiki.servarr.com/sonarr/faq\#can-i-switch-between-branches) Can I switch between branches
...
# [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-and-series-issues-metadata) Sonarr and Series Issues + Metadata

## [¶](https://wiki.servarr.com/sonarr/faq\#how-does-sonarr-handle-scene-numbering-issues-american-dad-etc) How does Sonarr handle scene numbering issues (American Dad!, etc)

### [¶](https://wiki.servarr.com/sonarr/faq\#how-sonarr-handles-scene-numbering-issues) How Sonarr handles scene numbering issues
...
### [¶](https://wiki.servarr.com/sonarr/faq\#problematic-shows) Problematic Shows
...
- Bleach: Thousand-Year Blood War
  - The newest season of Bleach: Thousand-Year Blood War is being released with a variety of different naming schemes making it difficult to automate and potentially overwriting some of your existing episodes. It can only be automated if your release group is either:
    ...
    - Releasing them with the correct Season 2 series title (found here [https://thexem.info/xem/show/5476](https://thexem.info/xem/show/5476)) and have began this new arc at absolute episode number 1.
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-cant-sonarr-import-episode-files-for-series-x-why-cant-sonarr-find-releases-for-series-x) Why can't Sonarr import episode files for series X? / Why can't Sonarr find releases for series X
...
- We are aware that some series are just plain difficult. You may also wish to review the [FAQ Entry for Problematic Shows and Release Group vs. TVDb numbering issues](https://wiki.servarr.com/sonarr/faq#how-does-sonarr-handle-scene-numbering-issues-american-dad-etc).

## [¶](https://wiki.servarr.com/sonarr/faq\#tvdb-is-updated-why-isnt-sonarr) TVDb is updated why isn't Sonarr
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-can-i-not-add-a-series) Why can I not add a series
...
- Sonarr cannot add any series that does not have an English language title. If you try to add a series via TVDb ID that does not have an English title. If no English title exists for that series on TheTVDb it will need to be added and then [one will need to wait for TVDb's cache to clear](https://wiki.servarr.com/sonarr/faq#tvdb).
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-can-i-not-add-a-series-when-i-know-the-tvdb-id) Why can I not add a series when I know the TVDb ID
...
- Check the URL / series - Sonarr does not support movies; use [Radarr](https://wiki.servarr.com/radarr) for movies

## [¶](https://wiki.servarr.com/sonarr/faq\#title-slug-in-use) Title Slug in Use

- There are two primary causes of this error that are listed below.

## [¶](https://wiki.servarr.com/sonarr/faq\#duplicate-names-no-year) Duplicate Names No Year
...
- This error often occurs when two series are named with the same title on TheTVDB, if this is the case the second series should have the year appended to the series title.
  - Series A
  - Series A (2021)
- To rectify this, wait for someone to eventually (maybe) update TVDb or update TVDb yourself. Once corrected **and once approved by TVDb's moderators**, due to [TVDb's API issues](https://wiki.servarr.com/sonarr/faq#tvdb-is-updated-why-isnt-sonarr), once updated you'll need to wait 30+ hours before the corrected title can be used in Sonarr.

## [¶](https://wiki.servarr.com/sonarr/faq\#duplicate-names-punctuation) Duplicate Names Punctuation
...
## [¶](https://wiki.servarr.com/sonarr/faq\#episode-does-not-have-an-absolute-number) Episode does not have an absolute number
...
## [¶](https://wiki.servarr.com/sonarr/faq\#episode-air-times) Episode Air Times
...
# [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-common-problems) Sonarr Common Problems

## [¶](https://wiki.servarr.com/sonarr/faq\#path-is-already-configured-for-an-existing-series) Path is Already Configured for an Existing Series
...
## [¶](https://wiki.servarr.com/sonarr/faq\#system-logs-loads-forever) System & Logs loads forever
...
## [¶](https://wiki.servarr.com/sonarr/faq\#weird-ui-issues) Weird UI Issues
...
## [¶](https://wiki.servarr.com/sonarr/faq\#web-interface-only-loads-at-localhost-on-windows) Web Interface Only Loads at localhost on Windows

- If you can only reach your web interface at [http://localhost:8989/](http://localhost:8989/) or [http://127.0.0.1:8989](http://127.0.0.1:8989/), you need to run Sonarr as administrator at least once.

## [¶](https://wiki.servarr.com/sonarr/faq\#i-got-a-pop-up-that-said-configxml-was-corrupt-what-now) I got a pop-up that said config.xml was corrupt, what now

- Sonarr was unable to read your config file on start-up as it became corrupted somehow. In order to get Sonarr back online, you will need to delete `.xml` in your [AppData Folder](https://wiki.servarr.com/sonarr/appdata-directory) once deleted start Sonarr and it will start on the default port (8989), you should now re-configure any settings you configured on the General Settings page.

## [¶](https://wiki.servarr.com/sonarr/faq\#invalid-certificate-and-other-https-or-ssl-issues) Invalid Certificate and other HTTPS or SSL issues

- If you're on non-Windows, most likely your mono's certificates are out of date and need to be synced. [See the section about mono ssl in the installation article for details](https://wiki.servarr.com/sonarr/installation#mono-ssl-issues)
...
## [¶](https://wiki.servarr.com/sonarr/faq\#how-do-i-stop-the-browser-from-launching-on-startup) How do I stop the browser from launching on startup
...
## [¶](https://wiki.servarr.com/sonarr/faq\#vpns-jackett-and-the-arrs) VPNs, Jackett, and the \*ARRs
...
### [¶](https://wiki.servarr.com/sonarr/faq\#use-of-a-vpn) Use of a VPN
...
## [¶](https://wiki.servarr.com/sonarr/faq\#i-see-log-messages-for-shows-i-do-not-havedo-not-want) I see log messages for shows I do not have/do not want
...
## [¶](https://wiki.servarr.com/sonarr/faq\#seeding-torrents-arent-deleted-automatically) Seeding torrents aren't deleted automatically
...
## [¶](https://wiki.servarr.com/sonarr/faq\#help-my-mac-says-sonarr-cannot-be-opened-because-the-developer-cannot-be-verified) Help, my Mac says Sonarr cannot be opened because the developer cannot be verified
...
\[![Developer Cannot be verified](https://wiki.servarr.com/assets/general/faq_1_mac.png)\]

## [¶](https://wiki.servarr.com/sonarr/faq\#help-my-mac-says-sonarrapp-is-damaged-and-cannot-be-opened) Help, my Mac says Sonarr.app is damaged and cannot be opened

- That is either due to a corrupt download so try again or [security issues, please see this related FAQ entry.](https://wiki.servarr.com/sonarr/faq#help-my-mac-says-sonarr-cannot-be-opened-because-the-developer-cannot-be-verified)

## [¶](https://wiki.servarr.com/sonarr/faq\#i-am-getting-an-error-database-disk-image-is-malformed) I am getting an error: Database disk image is malformed
...
- Your best and first option is to [try restoring from a backup](https://wiki.servarr.com/sonarr/faq#how-do-i-backuprestore-my-sonarr)
...
## [¶](https://wiki.servarr.com/sonarr/faq\#i-use-sonarr-on-a-mac-and-it-suddenly-stopped-working-what-happened) I use Sonarr on a Mac and it suddenly stopped working. What happened

- Most likely this is due to a MacOS bug which caused one of the Sonarr databases to be corrupted.
- [Follow these steps to resolve](https://wiki.servarr.com/sonarr/faq#i-am-getting-an-error-database-disk-image-is-malformed)
...
## [¶](https://wiki.servarr.com/sonarr/faq\#why-can-sonarr-not-see-my-files-on-a-remote-server) Why can Sonarr not see my files on a remote server
...
### [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-runs-under-the-localservice-account-by-default-which-doesnt-have-access-to-protected-remote-file-shares) Sonarr runs under the LocalService account by default which doesn't have access to protected remote file shares
...
### [¶](https://wiki.servarr.com/sonarr/faq\#youre-using-a-mapped-network-drive-not-a-unc-path) You're using a mapped network drive (not a UNC path)

- Change your paths to UNC paths (`\\server\share`)
- Run Sonarr.exe via the Startup Folder

## [¶](https://wiki.servarr.com/sonarr/faq\#mapped-network-drives-vs-unc-paths) Mapped Network Drives vs UNC Paths
...
## [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-will-not-work-on-big-sure) Sonarr will not work on Big Sure
...
## [¶](https://wiki.servarr.com/sonarr/faq\#my-custom-script-stopped-working-after-upgrading-from-v2) My Custom Script stopped working after upgrading from v2
...
# [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-searching-downloading-common-problems) Sonarr Searching & Downloading Common Problems

## [¶](https://wiki.servarr.com/sonarr/faq\#query-successful-no-results-returned) Query Successful - No Results Returned

- [See this troubleshooting entry](https://wiki.servarr.com/sonarr/troubleshooting#query-successful-no-results-returned)

## [¶](https://wiki.servarr.com/sonarr/faq\#why-didnt-sonarr-grab-an-episode-i-was-expecting) Why didn't Sonarr grab an episode I was expecting

First, make sure you read and understand the section above called ["How does Sonarr find episodes?](https://wiki.servarr.com/sonarr/faq#how-does-sonarr-find-episodes) Second, make sure at least one of your indexers has the episode you were expecting to be grabbed.
...
4. **If there is no manual result from a show, but you can find it when you browse your indexer's website** \- This can be caused by a number of reasons, for example the release is not properly tagged on your indexer causing it to not be returned to sonarr in an automatic search. This [troubleshooting entry](https://wiki.servarr.com/sonarr/troubleshooting#searches-indexers-and-trackers) provides some tips on how to determine the cause. Having several indexers active can help solve this by providing more sources to the same content.

## [¶](https://wiki.servarr.com/sonarr/faq\#found-matching-series-via-grab-history-but-release-was-matched-to-series-by-id-automatic-import-is-not-possible) Found matching series via grab history, but release was matched to series by ID. Automatic import is not possible

- See [this troubleshooting entry](https://wiki.servarr.com/sonarr/troubleshooting#found-matching-series-via-grab-history-but-series-was-matched-by-series-id-automatic-import-is-not-possible)

## [¶](https://wiki.servarr.com/sonarr/faq\#tba-episode-naming) TBA Episode Naming

- On TVDb, when episode names are unknown they'll be titled TBA and there is a cache on the TVDb API. The [Episode Title Required setting](https://wiki.servarr.com/sonarr/settings#importing) in Sonarr controls import behavior when the title is TBA, but after 48 hours from series airing the release will be imported even if the title is still TBA. There is also no automatic follow up renaming of TBA titled files. Note that the TBA timer is calculated from the episode airdate and time, not from when you've grabbed it or the upload time.
- Details on TVDb and Skyhook's cache can be found in the FAQ [TVDb is updated why isn't Sonarr?](https://wiki.servarr.com/sonarr/faq#tvdb-is-updated-why-isnt-sonarr)

## [¶](https://wiki.servarr.com/sonarr/faq\#sonarr-says-unknown-series-on-searches-or-imports) Sonarr says Unknown Series on Searches or Imports

- See the [Why can't Sonarr import episode files for series X? / Why can't Sonarr find releases for series X?](https://wiki.servarr.com/sonarr/faq#why-cant-sonarr-import-episode-files-for-series-x-why-cant-sonarr-find-releases-for-series-x) entry

## [¶](https://wiki.servarr.com/sonarr/faq\#jacketts-all-endpoint) Jackett's /all Endpoint
...
### [¶](https://wiki.servarr.com/sonarr/faq\#jackett-all-solutions) Jackett /All Solutions
...
## [¶](https://wiki.servarr.com/sonarr/faq\#jackett-shows-more-results-than-sonarr-when-manually-searching) Jackett shows more results than Sonarr when manually searching

- Check your configured categories for your tracker in Sonarr
- This is usually due to Sonarr searching Jackett differently than you do. [See this troubleshooting article for further information](https://wiki.servarr.com/sonarr/troubleshooting#searches-indexers-and-trackers).

## [¶](https://wiki.servarr.com/sonarr/faq\#finding-cookies) Finding Cookies

- Some sites cannot be logged into automatically and require you to login manually then give the cookies to Sonarr to work. [Please see this article for details.](https://wiki.servarr.com/useful-tools#finding-cookies)

## [¶](https://wiki.servarr.com/sonarr/faq\#unpack-torrents) Unpack Torrents
...
## [¶](https://wiki.servarr.com/sonarr/faq\#permissions) Permissions
...
## [¶](https://wiki.servarr.com/sonarr/faq\#forced-authentication) Forced Authentication

- In Sonarr v4 (beta) authentication is mandatory. Please see the [Sonarr v4 FAQ - Forced Authentication](https://wiki.servarr.com/sonarr/faq-v4#forced-authentication) for details

## [¶](https://wiki.servarr.com/sonarr/faq\#removing-completed-torrents) Removing Completed Torrents
...
- Some torrent clients do not have this ability. See [this page](https://wiki.servarr.com/sonarr/settings#torrent-client-remove-download-compatibility) for details for your client.
