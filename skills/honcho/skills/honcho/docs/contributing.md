> Source: https://honcho.dev/docs/v3/contributing/guidelines.md
...
`honcho start --setup` (Docker + an LLM provider key) — [CLI reference](/docs/v3/documentation/reference/cli).
