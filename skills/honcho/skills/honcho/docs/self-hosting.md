> Source: https://honcho.dev/docs/v3/contributing/self-hosting.md
...
Point MCP clients at `http://127.0.0.1:3000` — see [Run locally](/docs/v3/guides/integrations/mcp#run-locally) for stdio, HTTP, and Docker.
