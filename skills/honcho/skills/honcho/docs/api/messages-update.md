> Source: https://docs.honcho.dev/v3/api-reference/endpoint/messages/update-message.md
...
````yaml put /v3/workspaces/{workspace_id}/sessions/{session_id}/messages/{message_id}
openapi: 3.1.0
info:
  title: Honcho API
