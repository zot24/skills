> Source: https://honcho.dev/docs/v1/api-reference/endpoint/sessions/delete-session.md
...
````yaml delete /v1/apps/{app_id}/users/{user_id}/sessions/{session_id}
openapi: 3.1.0
info:
  title: Honcho API
...
paths:
  /v1/apps/{app_id}/users/{user_id}/sessions/{session_id}:
    delete:
      ...
      operationId: >-
        delete_session_v1_apps__app_id__users__user_id__sessions__session_id__delete
      parameters:
        - name: app_id
          in: path
          required: true
