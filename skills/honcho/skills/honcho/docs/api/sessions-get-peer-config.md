> Source: https://honcho.dev/docs/v2/api-reference/endpoint/sessions/get-peer-config.md
...
````yaml get /v2/workspaces/{workspace_id}/sessions/{session_id}/peers/{peer_id}/config
openapi: 3.1.0
info:
  title: Honcho API
