> Source: https://docs.honcho.dev/v3/api-reference/endpoint/messages/get-message.md
...
````yaml get /v3/workspaces/{workspace_id}/sessions/{session_id}/messages/{message_id}
openapi: 3.1.0
info:
  title: Honcho API
