> Source: https://honcho.dev/docs/v1/api-reference/endpoint/documents/create-document.md
...
````yaml post /v1/apps/{app_id}/users/{user_id}/collections/{collection_id}/documents
openapi: 3.1.0
info:
  title: Honcho API
...
paths:
  /v1/apps/{app_id}/users/{user_id}/collections/{collection_id}/documents:
    post:
      ...
      operationId: >-
        create_document_v1_apps__app_id__users__user_id__collections__collection_id__documents_post
      parameters:
        - name: app_id
          in: path
          required: true
