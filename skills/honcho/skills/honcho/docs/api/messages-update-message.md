> Source: https://honcho.dev/docs/v1/api-reference/endpoint/messages/update-message.md
...
````yaml put /v1/apps/{app_id}/users/{user_id}/sessions/{session_id}/messages/{message_id}
openapi: 3.1.0
info:
  title: Honcho API
