> Source: https://honcho.dev/docs/v1/api-reference/endpoint/documents/update-document.md
...
````yaml put /v1/apps/{app_id}/users/{user_id}/collections/{collection_id}/documents/{document_id}
openapi: 3.1.0
info:
  title: Honcho API
