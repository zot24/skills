> Source: https://honcho.dev/docs/v2/api-reference/endpoint/sessions/add-peers-to-session.md
...
````yaml post /v2/workspaces/{workspace_id}/sessions/{session_id}/peers
openapi: 3.1.0
info:
  title: Honcho API
...
paths:
  /v2/workspaces/{workspace_id}/sessions/{session_id}/peers:
    post:
      ...
      operationId: >-
        add_peers_to_session_v2_workspaces__workspace_id__sessions__session_id__peers_post
      parameters:
        - name: workspace_id
          in: path
          required: true
