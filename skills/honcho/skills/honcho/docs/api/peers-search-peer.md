> Source: https://honcho.dev/docs/v2/api-reference/endpoint/peers/search-peer.md
...
````yaml post /v2/workspaces/{workspace_id}/peers/{peer_id}/search
openapi: 3.1.0
info:
  title: Honcho API
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Search Peer V2 Workspaces  Workspace Id  Peers  Peer
                  Id  Search Post
        '422':
