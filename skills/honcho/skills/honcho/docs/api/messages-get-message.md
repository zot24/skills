> Source: https://honcho.dev/docs/v1/api-reference/endpoint/messages/get-message.md
...
````yaml get /v1/apps/{app_id}/users/{user_id}/sessions/{session_id}/messages/{message_id}
openapi: 3.1.0
info:
  title: Honcho API
...
paths:
  /v1/apps/{app_id}/users/{user_id}/sessions/{session_id}/messages/{message_id}:
    get:
      ...
      operationId: >-
        get_message_v1_apps__app_id__users__user_id__sessions__session_id__messages__message_id__get
      parameters:
        - name: app_id
          in: path
          required: true
