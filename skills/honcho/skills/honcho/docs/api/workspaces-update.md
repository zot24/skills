> Source: https://docs.honcho.dev/v3/api-reference/endpoint/workspaces/update-workspace.md
...
````yaml put /v3/workspaces/{workspace_id}
openapi: 3.1.0
info:
  title: Honcho API
...
paths:
  /v3/workspaces/{workspace_id}:
    put:
      ...
      operationId: update_workspace_v3_workspaces__workspace_id__put
      parameters:
        - name: workspace_id
          in: path
          required: true
