> Source: https://honcho.dev/docs/v2/api-reference/endpoint/messages/create-messages-with-file.md
...
````yaml post /v2/workspaces/{workspace_id}/sessions/{session_id}/messages/upload
openapi: 3.1.0
info:
  title: Honcho API
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Create Messages With File V2 Workspaces  Workspace
