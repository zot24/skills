> Source: https://honcho.dev/docs/v1/api-reference/endpoint/sessions/get-session.md
...
````yaml get /v1/apps/{app_id}/users/{user_id}/sessions
openapi: 3.1.0
info:
  title: Honcho API
  ...
  /v1/apps/{app_id}/users/{user_id}/sessions:
    get:
      ...
      description: >-
        ...
        If session_id is provided as a query parameter, it uses that (must match
        JWT session_id).
