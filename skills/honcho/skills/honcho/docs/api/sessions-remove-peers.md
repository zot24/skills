> Source: https://honcho.dev/docs/v3/api-reference/endpoint/sessions/remove-peers-from-session.md
  ...
  /v3/workspaces/{workspace_id}/sessions/{session_id}/peers:
    delete:
      ...
      description: >-
        ...
        Scope peers cannot be removed here; scope membership is managed via the
        scopes routes.
      operationId: >-
