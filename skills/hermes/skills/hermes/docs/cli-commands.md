...
### `hermes-agent` (legacy single-query runner)<a href="#hermes-agent-legacy-single-query-runner" class="hash-link" aria-label="Direct link to hermes-agent-legacy-single-query-runner" translate="no" title="Direct link to hermes-agent-legacy-single-query-runner">​</a>
...
| `hermes codex-runtime`                                | Noninteractive counterpart of `/codex-runtime`: `migrate [--dry-run] [--json]` regenerates the Hermes-managed block in `~/.codex/config.toml` for the selected profile. See [Codex app-server runtime](/docs/user-guide/features/codex-app-server-runtime#running-the-migration-from-a-script). |
...
### `--format stream-json` — structured JSONL output<a href="#--format-stream-json--structured-jsonl-output" class="hash-link" aria-label="Direct link to --format-stream-json--structured-jsonl-output" translate="no" title="Direct link to --format-stream-json--structured-jsonl-output">​</a>
...
#### Exit codes for one-shot runs<a href="#exit-codes-for-one-shot-runs" class="hash-link" aria-label="Direct link to Exit codes for one-shot runs" translate="no" title="Direct link to Exit codes for one-shot runs">​</a>
...
#### Delegation in finite chat runs<a href="#delegation-in-finite-chat-runs" class="hash-link" aria-label="Direct link to Delegation in finite chat runs" translate="no" title="Direct link to Delegation in finite chat runs">​</a>
...
### `hermes -z <prompt>` — scripted one-shot<a href="#hermes--z-prompt--scripted-one-shot" class="hash-link" aria-label="Direct link to hermes--z-prompt--scripted-one-shot" translate="no" title="Direct link to hermes--z-prompt--scripted-one-shot">​</a>
...
## `hermes lsp`<a href="#hermes-lsp" class="hash-link" aria-label="Direct link to hermes-lsp" translate="no" title="Direct link to hermes-lsp">​</a>
...
## `hermes portal`<a href="#hermes-portal" class="hash-link" aria-label="Direct link to hermes-portal" translate="no" title="Direct link to hermes-portal">​</a>
...
## `hermes send`<a href="#hermes-send" class="hash-link" aria-label="Direct link to hermes-send" translate="no" title="Direct link to hermes-send">​</a>
...
### Sending images and other media<a href="#sending-images-and-other-media" class="hash-link" aria-label="Direct link to Sending images and other media" translate="no" title="Direct link to Sending images and other media">​</a>
...
## `hermes peer`<a href="#hermes-peer" class="hash-link" aria-label="Direct link to hermes-peer" translate="no" title="Direct link to hermes-peer">​</a>
...
## `hermes secrets`<a href="#hermes-secrets" class="hash-link" aria-label="Direct link to hermes-secrets" translate="no" title="Direct link to hermes-secrets">​</a>
...
## `hermes codex-runtime`<a href="#hermes-codex-runtime" class="hash-link" aria-label="Direct link to hermes-codex-runtime" translate="no" title="Direct link to hermes-codex-runtime">​</a>
...
## `hermes proxy`<a href="#hermes-proxy" class="hash-link" aria-label="Direct link to hermes-proxy" translate="no" title="Direct link to hermes-proxy">​</a>
...
## `hermes security`<a href="#hermes-security" class="hash-link" aria-label="Direct link to hermes-security" translate="no" title="Direct link to hermes-security">​</a>
...
On-demand vulnerability scan against <a href="https://osv.dev" target="_blank" rel="noopener noreferrer">OSV.dev</a>. Covers the Hermes venv (installed PyPI distributions), Python dependencies declared by plugins under `~/.hermes/plugins/`, and pinned `npx`/`uvx` MCP servers in `config.yaml`. Does NOT scan globally-installed packages or editor/browser extensions.
...
## `hermes usage`<a href="#hermes-usage" class="hash-link" aria-label="Direct link to hermes-usage" translate="no" title="Direct link to hermes-usage">​</a>
...
## `hermes kanban`<a href="#hermes-kanban" class="hash-link" aria-label="Direct link to hermes-kanban" translate="no" title="Direct link to hermes-kanban">​</a>
...
## `hermes checkpoints`<a href="#hermes-checkpoints" class="hash-link" aria-label="Direct link to hermes-checkpoints" translate="no" title="Direct link to hermes-checkpoints">​</a>
...
### SQLite databases<a href="#sqlite-databases" class="hash-link" aria-label="Direct link to SQLite databases" translate="no" title="Direct link to SQLite databases">​</a>
...
### Examples<a href="#examples-4" class="hash-link" aria-label="Direct link to Examples" translate="no" title="Direct link to Examples">​</a>
...
### Dots inside key names<a href="#dots-inside-key-names" class="hash-link" aria-label="Direct link to Dots inside key names" translate="no" title="Direct link to Dots inside key names">​</a>
...
- `--source browse-sh` searches <a href="https://browse.sh" target="_blank" rel="noopener noreferrer">browse.sh</a>'s catalog of 200+ site-specific browser-automation skills. Identifiers look like `browse-sh/airbnb.com/search-listings-ddgioa`.
...
## `hermes bundles`<a href="#hermes-bundles" class="hash-link" aria-label="Direct link to hermes-bundles" translate="no" title="Direct link to hermes-bundles">​</a>
...
## `hermes curator`<a href="#hermes-curator" class="hash-link" aria-label="Direct link to hermes-curator" translate="no" title="Direct link to hermes-curator">​</a>
...
## `hermes moa`<a href="#hermes-moa" class="hash-link" aria-label="Direct link to hermes-moa" translate="no" title="Direct link to hermes-moa">​</a>
...
## `hermes fallback`<a href="#hermes-fallback" class="hash-link" aria-label="Direct link to hermes-fallback" translate="no" title="Direct link to hermes-fallback">​</a>
...
## `hermes hooks`<a href="#hermes-hooks" class="hash-link" aria-label="Direct link to hermes-hooks" translate="no" title="Direct link to hermes-hooks">​</a>
...
## `hermes computer-use`<a href="#hermes-computer-use" class="hash-link" aria-label="Direct link to hermes-computer-use" translate="no" title="Direct link to hermes-computer-use">​</a>
...
`hermes computer-use install` is the stable entry point for installing the <a href="https://github.com/trycua/cua" target="_blank" rel="noopener noreferrer">cua-driver</a> binary used by the `computer_use` toolset. It runs the same upstream installer that `hermes tools` invokes when you first enable Computer Use, so it's safe to use for re-running the install if the toolset toggle didn't trigger it (for example, on returning-user setups).
...
## `hermes pets`<a href="#hermes-pets" class="hash-link" aria-label="Direct link to hermes-pets" translate="no" title="Direct link to hermes-pets">​</a>
...
<a href="https://github.com/crafter-station/petdex" target="_blank" rel="noopener noreferrer">Petdex</a> is a public gallery of animated sprite pets for coding agents. Install one and Hermes shows it reacting to agent activity across the CLI, TUI, and desktop app.
...
### Examples<a href="#examples-5" class="hash-link" aria-label="Direct link to Examples" translate="no" title="Direct link to Examples">​</a>
...
## `hermes update`<a href="#hermes-update" class="hash-link" aria-label="Direct link to hermes-update" translate="no" title="Direct link to hermes-update">​</a>
...
- <a href="#global-entrypoint" class="table-of-contents__link toc-highlight">Global entrypoint</a>
  ...
  - <a href="#hermes-agent-legacy-single-query-runner" class="table-of-contents__link toc-highlight"><code>hermes-agent</code> (legacy single-query runner)</a>
...
- <a href="#hermes-chat" class="table-of-contents__link toc-highlight"><code>hermes chat</code></a>
  - <a href="#--format-stream-json--structured-jsonl-output" class="table-of-contents__link toc-highlight"><code>--format stream-json</code> — structured JSONL output</a>
  - <a href="#hermes--z-prompt--scripted-one-shot" class="table-of-contents__link toc-highlight"><code>hermes -z &lt;prompt&gt;</code> — scripted one-shot</a>
...
- <a href="#hermes-lsp" class="table-of-contents__link toc-highlight"><code>hermes lsp</code></a>
- <a href="#hermes-setup" class="table-of-contents__link toc-highlight"><code>hermes setup</code></a>
- <a href="#hermes-portal" class="table-of-contents__link toc-highlight"><code>hermes portal</code></a>
...
- <a href="#hermes-send" class="table-of-contents__link toc-highlight"><code>hermes send</code></a>
  - <a href="#sending-images-and-other-media" class="table-of-contents__link toc-highlight">Sending images and other media</a>
- <a href="#hermes-peer" class="table-of-contents__link toc-highlight"><code>hermes peer</code></a>
- <a href="#hermes-secrets" class="table-of-contents__link toc-highlight"><code>hermes secrets</code></a>
- <a href="#hermes-migrate" class="table-of-contents__link toc-highlight"><code>hermes migrate</code></a>
- <a href="#hermes-codex-runtime" class="table-of-contents__link toc-highlight"><code>hermes codex-runtime</code></a>
- <a href="#hermes-proxy" class="table-of-contents__link toc-highlight"><code>hermes proxy</code></a>
- <a href="#hermes-security" class="table-of-contents__link toc-highlight"><code>hermes security</code></a>
...
- <a href="#hermes-usage" class="table-of-contents__link toc-highlight"><code>hermes usage</code></a>
...
- <a href="#hermes-checkpoints" class="table-of-contents__link toc-highlight"><code>hermes checkpoints</code></a>
...
- <a href="#hermes-import" class="table-of-contents__link toc-highlight"><code>hermes import</code></a>
  - <a href="#sqlite-databases" class="table-of-contents__link toc-highlight">SQLite databases</a>
...
- <a href="#hermes-logs" class="table-of-contents__link toc-highlight"><code>hermes logs</code></a>
  ...
  - <a href="#options-1" class="table-of-contents__link toc-highlight">Options</a>
...
- <a href="#hermes-config" class="table-of-contents__link toc-highlight"><code>hermes config</code></a>
  - <a href="#dots-inside-key-names" class="table-of-contents__link toc-highlight">Dots inside key names</a>
...
- <a href="#hermes-bundles" class="table-of-contents__link toc-highlight"><code>hermes bundles</code></a>
- <a href="#hermes-curator" class="table-of-contents__link toc-highlight"><code>hermes curator</code></a>
- <a href="#hermes-moa" class="table-of-contents__link toc-highlight"><code>hermes moa</code></a>
- <a href="#hermes-fallback" class="table-of-contents__link toc-highlight"><code>hermes fallback</code></a>
- <a href="#hermes-hooks" class="table-of-contents__link toc-highlight"><code>hermes hooks</code></a>
...
- <a href="#hermes-computer-use" class="table-of-contents__link toc-highlight"><code>hermes computer-use</code></a>
- <a href="#hermes-pets" class="table-of-contents__link toc-highlight"><code>hermes pets</code></a>
