...
- **<a href="/docs/zh-Hans/assets/files/llms-96828202fb001238524b85bb053418e2.txt" target="_blank"><code>/llms.txt</code></a>** — 每个文档页面的精选索引，附简短描述。约 17 KB，可安全加载到 LLM 上下文中。
- **<a href="/docs/zh-Hans/assets/files/llms-full-229f3a50672b7a834f8928835ea7bd79.txt" target="_blank"><code>/llms-full.txt</code></a>** — 所有文档页面拼接为单一 markdown 文件，支持一次性摄取。约 1.8 MB。
