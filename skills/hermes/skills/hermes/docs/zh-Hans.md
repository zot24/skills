...
- **<a href="/docs/zh-Hans/assets/files/llms-b8352362c8c2f486e8175f652f49e593.txt" target="_blank"><code>/llms.txt</code></a>** — 每个文档页面的精选索引，附简短描述。约 17 KB，可安全加载到 LLM 上下文中。
- **<a href="/docs/zh-Hans/assets/files/llms-full-25017075daacaf6127ec2721148161d1.txt" target="_blank"><code>/llms-full.txt</code></a>** — 所有文档页面拼接为单一 markdown 文件，支持一次性摄取。约 1.8 MB。
