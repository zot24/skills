...
## Generated Durable Objects [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#generated-durable-objects)
...
## `wrangler.jsonc` [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#wranglerjsonc)
...
### Managing migrations [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#managing-migrations)
...
## Durable agent execution [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#durable-agent-execution)
...
## Workers AI and AI Gateway [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#workers-ai-and-ai-gateway)
...
## Cloudflare Sandbox [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#cloudflare-sandbox)
...
## Codemode [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#codemode)
...
## Extending Agents and Workflows on Cloudflare [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#extending-agents-and-workflows-on-cloudflare)
...
## Extending `cloudflare.ts` Entrypoint [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#extending-cloudflarets-entrypoint)
...
## Reference [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#reference)

### `extend(...)` [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#extend)
...
### `getCloudflareContext()` [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#getcloudflarecontext)
...
### `getDurableObjectIdentity()` [\#](https://flueframework.com/docs/guide/targets/cloudflare/\#getdurableobjectidentity)
