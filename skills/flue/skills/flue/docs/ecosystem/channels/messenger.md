...
## Quickstart [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#quickstart)
...
## Overview [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#overview)
...
## Configure [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#configure)
...
## Channel module [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#channel-module)
...
## Delivery behavior [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#delivery-behavior)
...
`event.message_edit`. Field names stay snake\_case (`mid`, `quick_reply.payload`,
...
## Identity and capabilities [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#identity-and-capabilities)
...
## Outbound behavior [\#](https://flueframework.com/docs/ecosystem/channels/messenger/\#outbound-behavior)
...
See the
[`@flue/messenger` API reference](https://flueframework.com/docs/api/messenger-channel/).
