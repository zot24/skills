...
## Quickstart [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#quickstart)
...
## Overview [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#overview)
...
## Configure [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#configure)
...
## Channel module [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#channel-module)
...
## Bind the tool [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#bind-the-tool)
...
## Verification and event shape [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#verification-and-event-shape)
...
## Responses, retries, and ordering [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#responses-retries-and-ordering)
...
## Compliance topics [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#compliance-topics)
...
## Cloudflare Workers [\#](https://flueframework.com/docs/ecosystem/channels/shopify/\#cloudflare-workers)
...
See the [`@flue/shopify` API reference](https://flueframework.com/docs/api/shopify-channel/).
