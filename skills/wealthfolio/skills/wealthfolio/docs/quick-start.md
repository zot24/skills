...
Learn how to get started with Wealthfolio, the open-source desktop portfolio tracker.
...
Install Wealthfolio, add your accounts, and see your first dashboard — a few minutes, start to finish. For what each concept means, see <a href="/docs/concepts/" class="font-medium underline underline-offset-4">Core Concepts</a>.

## Installation

1.  Visit the <a href="/download" class="font-medium underline underline-offset-4">download page</a> to get the latest version of Wealthfolio for your operating system.
...
When launching Wealthfolio, you’ll be greeted with an onboarding wizard. This will guide you through the setup process and the key steps you’ll need to take to get started.


Your browser does not support HTML5 video. Here is a <a href="https://assets.wealthfolio.app/videos/onboarding.mp4" data-astro-cid-4itgdthg="">link to the video</a> instead.


### 2. Add Your Accounts

Add your investment, bank, or crypto accounts.

1.  Click **Add your accounts**, or go to **Settings → Accounts**.

2.  Fill out the account form:

    - **Account Name** — a display label (e.g. *Main Brokerage*).
    - **Account Group** — optional; groups related accounts on the dashboard (e.g. *RRSP*).
    - **Account Type** — Securities, Cash, Credit Card, or Crypto.
    - **Currency** — the account’s currency (set once, at creation).
    - **Tracking Mode** — **Transactions** (record every trade) or **Holdings** (enter balances as snapshots). See <a href="/docs/concepts/tracking-modes/" class="font-medium underline underline-offset-4">Tracking Modes</a>.

    See <a href="/docs/concepts/#account" class="font-medium underline underline-offset-4">Core Concepts</a> for what each field means.

3.  Click **Save**. Repeat for each account.

### 3. Add or import activities

Record your holdings and cash movements one of two ways:

1.  Open **Activities** in the sidebar.
2.  **Add manually**, or **upload a CSV**. See the <a href="/docs/guide/csv-import/" class="font-medium underline underline-offset-4">CSV Import guide</a> for broker-specific recipes.

The core app imports data manually or by CSV. For automatic broker sync, see the optional <a href="/connect" class="font-medium underline underline-offset-4">Wealthfolio Connect</a>.

### 4. Explore Your Dashboards

After completing the initial setup, click “Let’s get started” to access your personalized Wealthfolio dashboard. Here, you can:
...
<img src="https://assets.wealthfolio.app/images/landing/holdings-charts.webp" class="h-full w-full overflow-hidden object-cover dark:hidden" loading="lazy" decoding="async" data-fetchpriority="auto" width="718" height="404" alt="Wealthfolio Holdings Dashboard" /><img src="https://assets.wealthfolio.app/images/landing/holdings-charts-dark.webp" class="hidden h-full w-full overflow-hidden object-cover dark:block" loading="lazy" decoding="async" data-fetchpriority="auto" width="718" height="404" alt="Wealthfolio Holdings Dashboard" /><img src="https://assets.wealthfolio.app/images/landing/income.webp" class="h-full w-full overflow-hidden object-cover dark:hidden" loading="lazy" decoding="async" data-fetchpriority="auto" width="718" height="404" alt="Wealthfolio Income Dashboard" /><img src="https://assets.wealthfolio.app/images/landing/income-dark.webp" class="hidden h-full w-full overflow-hidden object-cover dark:block" loading="lazy" decoding="async" data-fetchpriority="auto" width="718" height="404" alt="Wealthfolio Income Dashboard" />
...
This at-a-glance view allows you to quickly assess your overall financial health and the performance of individual accounts.

## Next steps

- <a href="/docs/guide/" class="font-medium underline underline-offset-4">User Guide</a> — dashboards, activities, goals, and more
- <a href="/docs/concepts/" class="font-medium underline underline-offset-4">Core Concepts</a> — how accounts, activities, and performance work
- <a href="/docs/guide/csv-import/" class="font-medium underline underline-offset-4">CSV Import</a> — bring in data from your broker
- <a href="/docs/guide/mcp-server/" class="font-medium underline underline-offset-4">MCP Server</a> — connect Claude, Cursor, or other AI agents to your portfolio


------------------------------------------------------------------------


<a href="/docs/introduction/" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:border-accent hover:text-accent-foreground h-10 px-4 py-2">Introduction</a> <a href="/docs/concepts/tracking-modes/" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:border-accent hover:text-accent-foreground h-10 px-4 py-2 ml-auto">Tracking Modes</a>


On This Page

- <a href="#installation" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">Installation</a>
- <a href="#first-steps" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">First Steps</a>
  - <a href="#1-launch-wealthfolio" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">1. Launch Wealthfolio</a>
  - <a href="#2-add-your-accounts" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">2. Add Your Accounts</a>
  - <a href="#3-add-or-import-activities" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">3. Add or import activities</a>
  - <a href="#4-explore-your-dashboards" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">4. Explore Your Dashboards</a>
- <a href="#next-steps" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">Next steps</a>
