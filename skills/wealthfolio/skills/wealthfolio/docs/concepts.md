...
Cash legs post to the synthetic symbol `$CASH-<CCY>` automatically. The saved amount is the final cash paid or received, including fees and taxes. See <a href="/docs/concepts/activity-fields/" class="font-medium underline underline-offset-4">Activity Fields</a> for field meanings and special cases.
...
- <a href="#account" class="inline-block leading-snug no-underline transition-colors text-muted-foreground/80 hover:text-foreground">Account</a>
