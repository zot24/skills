...
<a href="/connect/hashicorp" class="flex items-center space-x-3 group"><span class="group-hover:text-gray-900 dark:group-hover:text-white">Hashicorp Vault backend</span></a><a href="/connect/pulumi" class="flex items-center ml-auto space-x-3 group"><span class="group-hover:text-gray-900 dark:group-hover:text-white">Pulumi</span></a>
